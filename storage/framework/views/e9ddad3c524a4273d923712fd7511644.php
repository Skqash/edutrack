                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="total_semesters" class="form-label fw-bold">
                                        <i class="fas fa-layers text-primary"></i> Total Semesters
                                    </label>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="2" <?php echo e(old('total_semesters', $course->total_semesters) == '2' ? 'selected' : ''); ?>>2 Semesters (1 Year)</option>
                                        <option value="4" <?php echo e(old('total_semesters', $course->total_semesters) == '4' ? 'selected' : ''); ?>>4 Semesters (2 Years)</option>
                                        <option value="6" <?php echo e(old('total_semesters', $course->total_semesters) == '6' ? 'selected' : ''); ?>>6 Semesters (3 Years)</option>
                                        <option value="8" <?php echo e(old('total_semesters', $course->total_semesters) == '8' ? 'selected' : ''); ?>>8 Semesters (4 Years)</option>
                                        <option value="10" <?php echo e(old('total_semesters', $course->total_semesters) == '10' ? 'selected' : ''); ?>>10 Semesters (5 Years)</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($department->id); ?>" <?php echo e(old('department_id', $course->department_id) == $department->id ? 'selected' : ''); ?>>
