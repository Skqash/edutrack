    ...
    <div class="classes-grid">
        <?php $__empty_1 = true; $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="class-card fade-in" data-class-name="<?php echo e($class->class_name ?? ''); ?>"
                data-course-id="<?php echo e($class->program->id ?? ''); ?>" data-course="<?php echo e($class->program->program_name ?? ''); ?>"
                ...
                <div class="class-body">
                    <div class="stat-row">
                        ...
                        <div class="stat-item">
                            <div class="stat-value"><?php echo e($class->semester ?? 'N/A'); ?></div>
                    ...
                    <?php if($class->program): ?>
                        <div class="mb-3">
                            ...
                            <div class="fw-semibold"><?php echo e($class->program->program_name); ?></div>
                            <small class="text-muted"><?php echo e($class->program->program_code ?? 'N/A'); ?></small>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="<?php echo e(route('teacher.grades.content', $class->id)); ?>?term=midterm">
                                    <i class="fas fa-edit text-primary"></i> Midterm Grades
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('teacher.grades.content', $class->id)); ?>?term=final">
