...
<head>
    ...
    <title>Class Attendance Sheet - <?php echo e($class->class_name); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="controls" id="controls">
        <div class="control-group">
            ...
            <input type="date" id="sheetDate" value="<?php echo e($date); ?>" max="<?php echo e(now()->format('Y-m-d')); ?>">
        </div>
        <div class="control-group">
            <label for="sheetTerm">Select Term:</label>
            <select id="sheetTerm">
                <option value="Midterm" <?php echo e($term === 'Midterm' ? 'selected' : ''); ?>>Midterm</option>
                <option value="Final" <?php echo e($term === 'Final' ? 'selected' : ''); ?>>Final</option>
            </select>
        </div>
        <div class="control-group">
    ...
    <div class="page">
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <div class="info-value" style="min-width: 200px;"><?php echo e($class->subject->subject_name ?? 'N/A'); ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Course:</div>
                <div class="info-value date-field"><?php echo e($class->course->program_name ?? 'N/A'); ?></div>
            </div>
        </div>
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <div class="info-value date-field"><?php echo e(\Carbon\Carbon::parse($date)->format('M d, Y')); ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Term:</div>
                <div class="info-value date-field"><strong><?php echo e($term); ?></strong></div>
            </div>
        </div>
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <div class="info-value" style="min-width: 150px;"><?php echo e($class->schedule ?? '__________'); ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Faculty in-charge:</div>
                <div class="info-value"><?php echo e($class->teacher->name ?? '__________'); ?></div>
            </div>
        </div>
                        ...
                        <?php for($i = 1; $i <= 13; $i++): ?>
                            ...
                            <tr>
                                ...
                                <td class="student-name">
                                    <?php if($student): ?>
                                        <?php echo e(strtoupper($student->last_name ?? '')); ?>,
                                        <?php echo e(ucfirst($student->first_name ?? '')); ?>

                                        <?php if($student->middle_name): ?>
                                            <?php echo e(strtoupper(substr($student->middle_name, 0, 1))); ?>.
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </td>
                                <td class="signature-space">
                                    <?php if($attendance && $attendance->e_signature): ?>
                                        <img src="<?php echo e($attendance->e_signature); ?>" alt="Signature">
        ...
        <?php if($secondRowStudents->count() > 0): ?>
        ...
        <!-- Footer -->
        <div class="footer">
            <div class="doc-control">Doc Control Code: CPSU-F-VPAA-13 | Class: <?php echo e($class->class_name); ?></div>
            <div class="effective-date">Date: <?php echo e(\Carbon\Carbon::parse($date)->format('M d, Y')); ?> | Page No. 1 of 1
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function loadSheet() {
            ...
            window.location.href = `<?php echo e(route('teacher.attendance.sheet', ['classId' => 'CLASS_ID'])); ?>`.replace('CLASS_ID',
...
<?php /**PATH C:\laragon\www\edutrack\resources\views/teacher/attendance/sheet.blade.php ENDPATH**/ ?>