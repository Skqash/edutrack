        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <p class="text-muted mb-0"><strong>Class:</strong> <?php echo e($class->name); ?> | <strong>Term:</strong> <?php echo e(ucfirst($term)); ?></p>
                </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="ps-2">
                                <small><strong><?php echo e($student->roll_number ?? '-'); ?></strong></small>
                            </td>
                            <td class="ps-2">
                            ...
                            <?php $__currentLoopData = ['q1', 'q2', 'q3', 'q4', 'q5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td>
                                    <input type="number" 
                                           ...
                                           name="grades[<?php echo e($student->id); ?>][<?php echo e($quiz); ?>]" 
                            ...
                            <td>
                                <input type="number" 
                                       ...
                                       name="grades[<?php echo e($student->id); ?>][prelim_exam]" 
                            ...
                            <td>
                                <input type="number" 
                                       class="form-control form-control-sm exam-input" 
                                       name="grades[<?php echo e($student->id); ?>][midterm_exam]" 
                                       min="0" max="100" step="0.5" 
                                       data-student="<?php echo e($student->id); ?>"
                                       placeholder="0-100">
                            </td>
                            ...
                            <td>
                                <input type="number" 
                                       ...
                                       name="grades[<?php echo e($student->id); ?>][output_score]" 
                                       min="0" max="100" step="0.5" 
                                       data-student="<?php echo e($student->id); ?>"
                                       placeholder="0-100">
                            </td>
                            ...
                            <td>
                                <input type="number" 
                                       class="form-control form-control-sm skills-input" 
                                       name="grades[<?php echo e($student->id); ?>][activities_score]" 
                                       min="0" max="100" step="0.5" 
                                       data-student="<?php echo e($student->id); ?>"
                                       placeholder="0-100">
                            </td>
                            <td>
                                <input type="number" 
                                       class="form-control form-control-sm skills-input" 
                                       name="grades[<?php echo e($student->id); ?>][assignments_score]" 
                                       min="0" max="100" step="0.5" 
                                       data-student="<?php echo e($student->id); ?>"
                                       placeholder="0-100">
                            </td>
                            ...
                            <td>
                                <input type="number" 
                                       ...
                                       name="grades[<?php echo e($student->id); ?>][behavior_score]" 
                                       min="0" max="100" step="0.5" 
                                       data-student="<?php echo e($student->id); ?>"
                                       placeholder="0-100">
                            </td>
                            <td>
                                <input type="number" 
                                       class="form-control form-control-sm attitude-input" 
                                       name="grades[<?php echo e($student->id); ?>][awareness_score]" 
                                       min="0" max="100" step="0.5" 
                                       data-student="<?php echo e($student->id); ?>"
                                       placeholder="0-100">
                            </td>
                            ...
                            <td>
                                <input type="text" 
                                       ...
                                       name="grades[<?php echo e($student->id); ?>][final_grade]" 
                                       readonly
        ...
        <div class="row mt-4 mb-4">
            <div class="col-12">
                <div class="d-flex gap-2 justify-content-end">
                    <a href="<?php echo e(route('teacher.grades')); ?>" class="btn btn-secondary">
