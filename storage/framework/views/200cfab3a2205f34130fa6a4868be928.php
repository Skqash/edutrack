        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    <span class="badge bg-warning fs-6"><?php echo e($pendingCount); ?> Pending</span>
                    <span class="badge bg-success fs-6"><?php echo e($approvedCount); ?> Approved</span>
                    <span class="badge bg-danger fs-6"><?php echo e($rejectedCount); ?> Rejected</span>
                </div>
            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <p class="text-muted small mb-1">
                                                    ...
                                                    <strong>Teacher:</strong> <?php echo e($request->teacher->name); ?>

                                                </p>
                                                <p class="text-muted small mb-1">
                                                    <i class="fas fa-envelope me-1"></i>
                                                    <?php echo e($request->teacher->email); ?>

                                                </p>
                                                <?php if($request->teacher->campus): ?>
                                                    <p class="text-muted small mb-1">
                                                        <i class="fas fa-building me-1"></i>
                                                        <?php echo e($request->teacher->campus); ?>
                                            ...
                                            <?php if($request->reason): ?>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="text-muted small mb-0"><?php echo e(Str::limit($request->reason, 100)); ?></p>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <div class="d-flex gap-2">
                                                <button type="button" class="btn btn-success btn-sm flex-fill" onclick="approveRequest(<?php echo e($request->id); ?>)">
                                                    <i class="fas fa-check"></i> Approve
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm flex-fill" onclick="rejectRequest(<?php echo e($request->id); ?>, '<?php echo e($request->course->program_name); ?>')">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <small class="text-muted">
                                                    ...
                                                    Approved <?php echo e($request->approved_at->format('M d, Y')); ?>

                                                </small>
                                                <?php if($request->approvedBy): ?>
                                                    <small class="text-muted">
                                                        by <?php echo e($request->approvedBy->name); ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php if($request->admin_note): ?>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="text-muted small mb-0"><?php echo e($request->admin_note); ?></p>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <small class="text-muted">
                                                    ...
                                                    Rejected <?php echo e($request->approved_at->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/teachers/course_access_requests.blade.php ENDPATH**/ ?>