                    ...
                    <div class="row align-items-center g-3">
                        <div class="col-12 col-md">
                            <h5 class="mb-0 fw-bold">
                                <i class="fas fa-door-open text-primary me-2"></i><?php echo e($class->name); ?>

                            </h5>
                            <p class="mb-0 small text-muted mt-1">
                                <i class="fas fa-book me-1"></i>
                                <?php if($class->course): ?>
                                    <strong><?php echo e($class->course->course_name); ?></strong>
                                    <?php if($class->course->course_code): ?>
                                        <span class="text-muted">(<?php echo e($class->course->course_code); ?>)</span>
                                    <?php endif; ?>
                                <?php else: ?>
                        ...
                        <div class="col-12 col-md-auto">
                            ...
                            <input type="date" id="attendanceDate" class="form-control form-control-sm" value="<?php echo e($today); ?>" max="<?php echo e($today); ?>" style="min-width: 140px;">
                        </div>
                    </div>
                </div>
                    ...
                    <form action="<?php echo e(route('teacher.attendance.record', $class->id)); ?>" method="POST" id="attendanceForm">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr class="checklist-row">
                                            ...
                                            <td class="text-nowrap"><span class="badge bg-secondary"><?php echo e($student->student_id ?? '–'); ?></span></td>
                                            <td class="fw-medium"><?php echo e($student->user->name ?? 'N/A'); ?></td>
                                            <td class="text-center cell-status">
                                                <label class="checklist-cell present-cell mb-0">
                                                    <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]" value="Present" class="sr-only"
                                            ...
                                            <td class="text-center cell-status">
                                                <label class="checklist-cell absent-cell mb-0">
                                                    <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]" value="Absent" class="sr-only"
                                            ...
                                            <td class="text-center cell-status">
                                                <label class="checklist-cell late-cell mb-0">
                                                    <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]" value="Late" class="sr-only"
                                            ...
                                            <td class="text-center cell-status">
                                                <label class="checklist-cell excuse-cell mb-0">
                                                    <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]" value="Leave" class="sr-only"
                        ...
                        <div class="card-footer bg-light d-flex flex-column flex-sm-row justify-content-between align-items-stretch align-items-sm-center gap-2 py-3">
                            ...
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('teacher.attendance')); ?>" class="btn btn-outline-secondary">Cancel</a>
