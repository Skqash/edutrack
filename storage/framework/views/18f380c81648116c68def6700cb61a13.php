                ...
                <div class="card-body py-3">
                    ...
                    <div class="mt-3 pt-3 border-top">
                        <div class="row g-2 small">
                            ...
                            <div class="col-auto">
                                <a href="<?php echo e(route('teacher.attendance.settings', $class->id)); ?>" class="text-decoration-none">
                                ...
                                <div class="status-btns d-flex gap-1">
                                    ...
                                    <label class="status-btn excused-btn" title="Excused">
                                        <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]"
                                            ...
                                            <?php echo e($current && $current->status === 'Leave' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/teacher/attendance/manage.blade.php ENDPATH**/ ?>