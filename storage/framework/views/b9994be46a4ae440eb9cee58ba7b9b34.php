<?php $__env->startSection('content'); ?>
    <div class="container-fluid p-4">
                ...
                <table class="table table-hover mb-0" id="gradesTable">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="grade-row" data-class="<?php echo e($grade->class_id ?? ''); ?>"
                                data-subject="<?php echo e($grade->subject->subject_code ?? ''); ?>">
                                ...
                                <td>
                                    <strong
                                        class="text-<?php echo e($grade->grade === 'A' ? 'success' : ($grade->grade === 'F' ? 'danger' : 'warning')); ?>">
                                ...
                                <td>
                                    <button class="btn btn-sm btn-warning"
                                        onclick="editGrade(<?php echo e($grade->id); ?>)">Edit</button>
        ...
        <div class="mt-3">
            <form action="<?php echo e(route('super.grades.delete-all')); ?>" method="POST"
