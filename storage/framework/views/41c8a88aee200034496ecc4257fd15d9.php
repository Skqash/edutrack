            ...
            <div class="card stat-card bg-info text-white h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="text-white-50 mb-1">Total Students</h6>
                            <h3 class="mb-0"><?php echo e($class->total_students); ?></h3>
                        </div>
                        ...
                        <div>
                            ...
                            <h5 class="mb-0">
                                <span class="badge bg-light text-dark">
                                    <?php echo e(strtolower($class->status) === 'active' ? 'Active' : ($class->status ?? 'Active')); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $class->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="d-none d-md-table-cell">
                                                <small><?php echo e($student->email ?? 'N/A'); ?></small>
                                            </td>
                                            <td class="d-none d-lg-table-cell">
                                                <small><?php echo e($student->phone ?? 'N/A'); ?></small>
                                            </td>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="d-flex gap-2 flex-wrap">
                ...
                <a href="<?php echo e(route('teacher.grades.content', $class->id)); ?>?term=midterm" class="btn btn-primary">
