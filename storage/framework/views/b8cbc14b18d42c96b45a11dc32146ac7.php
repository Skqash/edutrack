...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('marks_obtained')); ?>" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('total_marks')); ?>" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>" id="grade" name="grade"
                                ...
                                <option value="A" <?php echo e(old('grade') == 'A' ? 'selected' : ''); ?>>A (90-100%)</option>
                                <option value="B" <?php echo e(old('grade') == 'B' ? 'selected' : ''); ?>>B (80-89%)</option>
                                <option value="C" <?php echo e(old('grade') == 'C' ? 'selected' : ''); ?>>C (70-79%)</option>
                                <option value="D" <?php echo e(old('grade') == 'D' ? 'selected' : ''); ?>>D (60-69%)</option>
                                <option value="F" <?php echo e(old('grade') == 'F' ? 'selected' : ''); ?>>F (Below 60%)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('academic_year')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\grades\create.blade.php ENDPATH**/ ?>