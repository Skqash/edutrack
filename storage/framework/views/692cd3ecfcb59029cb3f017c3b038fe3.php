...
<head>
    <meta charset="UTF-8">
    <title>Midterm Grades - <?php echo e($student->user->name); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="certificate-title">Midterm Grade Report</div>
            <div class="certificate-subtitle">Official Academic Record - Midterm</div>
        </div>

        <!-- TERM INDICATOR -->
        <div class="term-indicator">
            MIDTERM GRADES - <?php echo e(date('Y')); ?> Academic Year
        </div>
            ...
            <table class="grades-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 25%;">Midterm Grade</th>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; font-weight: bold;">
                                <?php if($grade->midterm_exam): ?>
                                    <?php if($grade->midterm_exam >= 75): ?>
                                        <span style="color: #28a745;"><?php echo e(number_format($grade->midterm_exam, 2)); ?></span>
                                    <?php else: ?>
                                        <span style="color: #dc3545;"><?php echo e(number_format($grade->midterm_exam, 2)); ?></span>
                                    <?php endif; ?>
                                <?php else: ?>
        ...
        <?php else: ?>
            <div class="grades-table">
                <div class="no-data">No midterm grade records found for this student.</div>
            </div>
        <?php endif; ?>
        ...
        <div class="footer">
            ...
            <div class="footer-text">This is an official midterm grade report. For verification, please contact the Registrar's Office.</div>
        </div>
...
<?php /**PATH C:\laragon\www\edutrack\resources\views\admin\grades\pdf-midterm.blade.php ENDPATH**/ ?>