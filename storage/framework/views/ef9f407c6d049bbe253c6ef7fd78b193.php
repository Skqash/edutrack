<?php $__env->startSection('content'); ?>
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 fw-bold mb-0"><?php echo e($class->name); ?> - Attendance</h1>
                    ...
                    <div class="col">
                        <h5 class="mb-0" style="color: #495057; font-weight: 600;">
                            ...
                            Attendance Date: <span id="dateDisplay"
                                style="color: #667eea; font-weight: 700;"><?php echo e($today); ?></span>
                        </h5>
                    </div>
                    <div class="col-auto">
                        <input type="date" id="attendanceDate" class="form-control form-control-sm"
                            value="<?php echo e($today); ?>" max="<?php echo e($today); ?>" style="max-width: 200px;">
                    </div>
                </div>
            </div>
            <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h6 class="mb-0" style="color: #212529; font-weight: 600;">
                                                        <?php echo e($student->user->name ?? 'N/A'); ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="attendance-checklist d-flex gap-2" style="flex-wrap: wrap;">
                                            ...
                                            <label class="attendance-checkbox">
                                                <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]"
                                                    ...
                                                    <?php echo e(isset($attendances[$student->id]) && $attendances[$student->id]->status === 'Present' ? 'checked' : ''); ?>>
                                            ...
                                            <label class="attendance-checkbox">
                                                <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]"
                                                    ...
                                                    <?php echo e(isset($attendances[$student->id]) && $attendances[$student->id]->status === 'Absent' ? 'checked' : ''); ?>>
                                            ...
                                            <label class="attendance-checkbox">
                                                <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]"
                                                    ...
                                                    <?php echo e(isset($attendances[$student->id]) && $attendances[$student->id]->status === 'Late' ? 'checked' : ''); ?>>
                                            ...
                                            <label class="attendance-checkbox">
                                                <input type="radio" name="attendance[<?php echo e($student->id); ?>][status]"
                                                    ...
                                                    <?php echo e(isset($attendances[$student->id]) && $attendances[$student->id]->status === 'Leave' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\teacher\attendance\manage_new.blade.php ENDPATH**/ ?>