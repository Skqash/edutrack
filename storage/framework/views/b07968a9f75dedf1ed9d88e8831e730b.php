    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <?php if($teacher): ?>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">
                                <?php echo e($teacher->campus ?? 'Victorias Campus'); ?>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">
                                <?php echo e($teacher->connected_school ?? 'Not connected yet'); ?>
        ...
        <div class="col-lg-4">
            ...
            <div class="card profile-card">
                <div class="card-body">
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="<?php echo e(route('teacher.school-request.create')); ?>" class="btn btn-sm btn-outline-success">
            ...
            <div class="card profile-card">
                ...
                <div class="card-body">
                    <?php if(isset($schoolRequest) && $schoolRequest): ?>
                        <div class="info-group">
                            <div class="info-label">Requested Institution</div>
                            <div class="info-value"><?php echo e($schoolRequest->school_name); ?></div>
                        </div>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">
                                <span
                                    class="badge bg-<?php echo e($schoolRequest->status === 'approved' ? 'success' : ($schoolRequest->status === 'rejected' ? 'danger' : 'secondary')); ?>">
                                    <?php echo e(ucfirst($schoolRequest->status)); ?>

                                </span>
                            </div>
                        </div>

                        <?php if($schoolRequest->admin_note): ?>
                            <div class="info-group">
                                <div class="info-label">Admin Note</div>
                                <div class="info-value"><?php echo e($schoolRequest->admin_note); ?></div>
                            </div>
                        <?php endif; ?>

                        <div class="info-group">
                            <div class="info-label">Submitted</div>
                            <div class="info-value small text-muted"><?php echo e($schoolRequest->created_at->diffForHumans()); ?>

                            </div>
                        </div>

                        <div class="d-flex gap-2 mt-3">
                            <a href="<?php echo e(route('teacher.school-requests.history')); ?>"
                                class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-history me-1"></i> View Request History
                            </a>
                            <a href="<?php echo e(route('teacher.school-request.create')); ?>"
                    ...
                    <?php else: ?>
                        ...
                        <div class="mt-3">
                            <a href="<?php echo e(route('teacher.school-request.create')); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\teacher\profile\show.blade.php ENDPATH**/ ?>