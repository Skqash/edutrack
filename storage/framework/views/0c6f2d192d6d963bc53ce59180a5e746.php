                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="total_quiz_items"
                                        value="<?php echo e(old('total_quiz_items', $range->total_quiz_items ?? 100)); ?>"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="num_quizzes"
                                        value="<?php echo e(old('num_quizzes', $range->num_quizzes ?? 5)); ?>" min="1"
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" name="equal_quiz_distribution"
                                    ...
                                    <?php echo e(old('equal_quiz_distribution', $range->equal_quiz_distribution ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm"
                                                ...
                                                value="<?php echo e(old('midterm_exam_max', $range->midterm_exam_max ?? 60)); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm" name="final_exam_max"
                                                value="<?php echo e(old('final_exam_max', $range->final_exam_max ?? 60)); ?>"
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control form-control-sm"
                                                    ...
                                                    value="<?php echo e(old('class_participation_max', $range->class_participation_max ?? 100)); ?>"
                                                    min="10" max="200"></td>
                                        </tr>
                                        <tr>
                                            <td>Activities:</td>
                                            <td><input type="number" class="form-control form-control-sm"
                                                    name="activities_max"
                                                    value="<?php echo e(old('activities_max', $range->activities_max ?? 100)); ?>"
                                                    min="10" max="200"></td>
                                        </tr>
                                        <tr>
                                            <td>Assignments:</td>
                                            <td><input type="number" class="form-control form-control-sm"
                                                    ...
                                                    value="<?php echo e(old('assignments_max', $range->assignments_max ?? 100)); ?>"
                                                    min="10" max="200"></td>
                                        </tr>
                                    </table>
                                </div>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\teacher\assessment\configure_advanced.blade.php ENDPATH**/ ?>