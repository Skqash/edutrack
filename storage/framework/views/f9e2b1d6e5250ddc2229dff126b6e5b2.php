<?php $__env->startSection('content'); ?>
    ...
    <div id="classes" class="tab-content active">
        <div class="attendance-container">
            <?php $__empty_1 = true; $__currentLoopData = $attendanceByClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classId => $classData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div class="attendance-card">
                    <div class="card-header" onclick="toggleCard(this)">
                        <div class="card-header-info">
                            <div class="card-title"><?php echo e($class->class_name); ?></div>
                            <div class="card-subtitle">
                                <span><?php echo e($stats['total']); ?> Records</span>
                                <span><?php echo e($stats['present']); ?> Present</span>
                                <span><?php echo e($stats['absent']); ?> Absent</span>
                            </div>
                        </div>
                    ...
                    <div class="card-content">
                        ...
                        <?php if($class->students->count() > 0): ?>
                            ...
                            <?php $__currentLoopData = $studentAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentId => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="week-section student-filter-item">
                                    <div class="week-title">
                                        ...
                                        <?php echo e($student->user->name ?? 'N/A'); ?>

                                        <?php if($records->count() == 0): ?>
                                            <span style="color: #999; font-size: 11px;">(No attendance records)</span>
                                        <?php else: ?>
                                            <span style="color: #666; font-size: 11px;">- <?php echo e($records->count()); ?>
                                    ...
                                    <?php if($records->count() > 0): ?>
                                        <?php $__currentLoopData = $groupedByWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week => $weekRecords): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <table class="attendance-table" style="margin-bottom: 10px;">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $weekRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($record->date ? \Carbon\Carbon::parse($record->date)->format('M d, Y') : 'N/A'); ?>

                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="status-badge status-<?php echo e(strtolower($record->status)); ?>">
    ...
    <div id="students" class="tab-content">
        <div class="attendance-container">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $allStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentId => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div class="attendance-card student-filter-item">
                    <div class="card-header" onclick="toggleCard(this)">
                        <div class="card-header-info">
                            ...
                            <div class="card-subtitle">
                                <span><?php echo e($totalRecords); ?> Records</span>
                                <span><?php echo e($presentCount); ?> Present</span>
                                <span><?php echo e($absentCount); ?> Absent</span>
                            </div>
                        </div>
                        <div class="card-header-icon">
                            <i class="fas fa-chevron-down"></i>
                        ...
                        <?php if($totalRecords > 0): ?>
                            <?php $__currentLoopData = $groupedByWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week => $weekRecords): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="week-section">
                                    <div class="week-title">Week <?php echo e(substr($week, 6)); ?>, <?php echo e(substr($week, 0, 4)); ?>
    ...
    <div id="teachers" class="tab-content">
        <div class="attendance-container">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $allTeachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacherId => $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    // Get teacher classes
                ...
                <div class="attendance-card teacher-filter-item">
                    <div class="card-header" onclick="toggleCard(this)">
                        <div class="card-header-info">
                            <div class="card-title"><?php echo e($teacher->name ?? 'N/A'); ?></div>
                            <div class="card-subtitle">
                                <span><?php echo e(count($teacherClasses)); ?> Classes</span>
                            </div>
                        </div>
                        <div class="card-header-icon">
                            <i class="fas fa-chevron-down"></i>
                    ...
                    <div class="card-content">
                        <?php $__currentLoopData = $teacherClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <?php if($class): ?>
                                <div class="week-section">
                                    <div class="week-title">📚 <?php echo e($class->class_name); ?></div>
                                    <table class="attendance-table">
                                        <thead>
                                            <tr>
                                                <th>Student</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo e($student->user->name ?? 'N/A'); ?></td>
                                                    <td>
                                                        <span class="status-badge status-present">✅
                                                            <?php echo e($presentCount); ?></span>
                                                        <span class="status-badge status-absent">❌
                                                            <?php echo e($absentCount); ?></span>
                                                        <span class="status-badge status-late">⏰
                                                            <?php echo e($lateCount); ?></span>
                                                        <span class="status-badge status-leave">📋
                                                            <?php echo e($leaveCount); ?></span>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\attendance\index.blade.php ENDPATH**/ ?>