                        ...
                        <div class="list-group mt-3">
                            ...
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="<?php echo e(route('super.cleanup.logs')); ?>" method="POST" style="display:inline;"
                            ...
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="<?php echo e(route('super.cleanup.cache')); ?>" method="POST" style="display:inline;"
                            ...
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="<?php echo e(route('super.cleanup.inactive-users')); ?>" method="POST"
                            ...
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="<?php echo e(route('super.cleanup.old-submissions')); ?>" method="POST"
                                        style="display:inline;"
                            ...
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="<?php echo e(route('super.cleanup.orphaned')); ?>" method="POST"
                            ...
                            <div class="list-group-item border-danger">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="<?php echo e(route('super.cleanup.reset-all')); ?>" method="POST"
                                        style="display:inline;"
                                        ...
                                        <div class="card bg-light">
                                            <div class="card-body">
                                                <h6 class="card-title text-muted">
                                                    <?php echo e(ucfirst(str_replace('_', ' ', $table))); ?></h6>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\super\tools\cleanup.blade.php ENDPATH**/ ?>