    ...
    <div class="page-header-modern">
        <div class="header-content">
            ...
            <div class="header-actions">
                ...
                <a href="<?php echo e(route('admin.subjects.create')); ?>" class="btn btn-modern btn-modern-white">
                    ...
                    <div class="d-flex align-items-center">
                        <div style="flex: 1;">
                            ...
                            <h2 class="mb-0 fw-bold" style="color: #0d6efd;">
                                <?php echo e($subjects->pluck('category')->unique()->count()); ?></h2>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div style="flex: 1;">
                            ...
                            <h2 class="mb-0 fw-bold" style="color: #fd7e14;">
                                <?php echo e($subjects->map(fn($s) => optional($s->program)->program_name ?? 'General Education')->unique()->count()); ?>
            ...
            <div class="card-header bg-white border-0">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <?php if($program !== 'General Education' && $programSubjects->first()->program): ?>
                            <small
                                class="text-muted ms-3">(<?php echo e($programSubjects->first()->program->program_code ?? 'N/A'); ?>)</small>
                        <?php endif; ?>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <div class="d-flex gap-2">
                            ...
                            <span class="badge bg-primary"><?php echo e($programSubjects->where('type', 'Core')->count()); ?>

                                Core</span>
                        </div>
                        <?php if($program !== 'General Education'): ?>
                            <button type="button" class="btn btn-sm btn-outline-secondary"
                                onclick="syncProgramSubjects('<?php echo e($program); ?>')" title="Sync subjects in this program">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $programSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <div>
                                            <strong class="text-dark"><?php echo e($subject->subject_code); ?></strong>
                                            <?php if($subject->campus_code): ?>
                                                <br><small class="text-muted">Campus: <?php echo e($subject->campus_code); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            ...
                                            <br><small
                                                class="text-muted"><?php echo e($subject->description ?? 'Learn fundamental concepts and principles'); ?></small>
                                        </div>
                                    </td>
                                    ...
                                    <td><span
                                            class="badge bg-<?php echo e($subject->type == 'Core' ? 'primary' : ($subject->type == 'Elective' ? 'warning' : 'info')); ?>"><?php echo e($subject->type ?? 'General'); ?></span>
                                    </td>
                                    <td>
                                        <?php if($subject->instructor): ?>
                                            <span
                                                class="badge bg-light text-dark border"><?php echo e($subject->instructor->name); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1 flex-wrap actions-container">
                                            ...
                                            <!-- Delete Subject -->
                                            <form action="<?php echo e(route('admin.subjects.destroy', $subject->id)); ?>"
