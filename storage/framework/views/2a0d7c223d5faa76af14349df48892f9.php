    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto ms-auto">
                <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-gradient-success">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge <?php echo e($user->role == 'teacher' ? 'bg-primary' : 'bg-info'); ?>">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="card shadow-sm mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="card-title mb-2"><?php echo e($user->name); ?></h5>
                                    <p class="mb-2 text-muted">
                                        <strong>Email:</strong> <?php echo e($user->email); ?>

                                    </p>
                                    <p class="mb-2">
                                        <strong>Phone:</strong> <?php echo e($user->phone ?? 'N/A'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\users\index.blade.php ENDPATH**/ ?>