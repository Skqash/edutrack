...
unset($__errorArgs, $__bag); ?>" id="employee_id" 
                               name="employee_id" placeholder="Enter employee ID" value="<?php echo e(old('employee_id')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="qualification" 
                               name="qualification" placeholder="e.g., Master of Education, PhD in Mathematics" value="<?php echo e(old('qualification')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="specialization" 
                               name="specialization" placeholder="e.g., Mathematics, Computer Science, English" value="<?php echo e(old('specialization')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="department" 
                               name="department" placeholder="e.g., College of Engineering, College of Education" value="<?php echo e(old('department')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($adminCampus ?? null): ?>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> This teacher will be assigned to <strong><?php echo e($adminCampus); ?></strong> campus.
                    </div>
                    <?php endif; ?>
