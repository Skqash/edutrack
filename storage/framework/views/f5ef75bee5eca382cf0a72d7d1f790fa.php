...
unset($__errorArgs, $__bag); ?>" id="name" 
                               name="name" placeholder="Enter full name" value="<?php echo e(old('name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="email" 
                               name="email" placeholder="Enter email" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="phone" 
                               name="phone" placeholder="Enter phone number" value="<?php echo e(old('phone')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/teachers/create.blade.php ENDPATH**/ ?>