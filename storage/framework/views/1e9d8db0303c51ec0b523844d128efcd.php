    ...
    <div class="row">
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.attendance.update', $attendance)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="student_id"
                                ...
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($student->id); ?>"
                                        <?php echo e($attendance->student_id == $student->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="class_id"
                                ...
                                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($class->id); ?>"
                                        <?php echo e($attendance->class_id == $class->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="date"
                                name="date" value="<?php echo e($attendance->date->format('Y-m-d')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status"
                                ...
                                <option value="Present" <?php echo e($attendance->status == 'Present' ? 'selected' : ''); ?>>Present
                                </option>
                                <option value="Absent" <?php echo e($attendance->status == 'Absent' ? 'selected' : ''); ?>>Absent
                                </option>
                                <option value="Late" <?php echo e($attendance->status == 'Late' ? 'selected' : ''); ?>>Late</option>
                                <option value="Leave" <?php echo e($attendance->status == 'Leave' ? 'selected' : ''); ?>>Leave
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="notes" name="notes" rows="3"><?php echo e($attendance->notes); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\attendance\edit.blade.php ENDPATH**/ ?>