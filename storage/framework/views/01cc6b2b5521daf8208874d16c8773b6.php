...
<div class="row">
    <div class="col-12 col-lg-8">
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="<?php echo e(route('admin.teachers.update', $teacher)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" 
                               name="name" value="<?php echo e($teacher->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="email" 
                               name="email" value="<?php echo e($teacher->email); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="phone" 
                               name="phone" value="<?php echo e($teacher->phone ?? ''); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/teachers/edit.blade.php ENDPATH**/ ?>