...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.teacher-assignments.update', $teacherAssignment)); ?>" method="POST" id="assignmentForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('teacher_id', $teacherAssignment->teacher_id) == $teacher->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <option value="active" <?php echo e(old('status', $teacherAssignment->status) == 'active' ? 'selected' : ''); ?>>Active</option>
                                        <option value="inactive" <?php echo e(old('status', $teacherAssignment->status) == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                                        <option value="completed" <?php echo e(old('status', $teacherAssignment->status) == 'completed' ? 'selected' : ''); ?>>Completed</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($year); ?>" <?php echo e(old('academic_year', $teacherAssignment->academic_year) == $year ? 'selected' : ''); ?>>
                                                <?php echo e($year); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($semester); ?>" <?php echo e(old('semester', $teacherAssignment->semester) == $semester ? 'selected' : ''); ?>>
                                                <?php echo e($semester); ?>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($department); ?>" <?php echo e(old('department', $teacherAssignment->department) == $department ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($class->id); ?>" 
                                                    ...
                                                    <?php echo e(old('class_id', $teacherAssignment->class_id) == $class->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($subject->id); ?>" 
                                                    ...
                                                    <?php echo e(old('subject_id', $teacherAssignment->subject_id) == $subject->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($course->id); ?>" 
                                                    ...
                                                    <?php echo e(old('course_id', $teacherAssignment->course_id) == $course->id ? 'selected' : ''); ?>>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="student-item selected">
                                                            <label class="d-flex align-items-center cursor-pointer">
                                                                <input type="checkbox" name="selected_students[]" value="<?php echo e($student->id); ?>" 
                                                                       class="student-checkbox" checked data-name="<?php echo e($student->user->name); ?>">
                                                                <div class="ms-2">
                                                                    <div class="fw-medium"><?php echo e($student->user->name); ?></div>
                                                                    <small class="text-muted">
                                                                        <?php echo e($student->student_id); ?> • Year <?php echo e($student->year); ?> • <?php echo e($student->section); ?> • <?php echo e($student->class?->class_name ?? 'N/A'); ?>
                                    ...
                                    <input type="hidden" name="student_ids" id="student_ids" value='<?php echo e(old("student_ids", json_encode($teacherAssignment->students->pluck("id")->toArray()))); ?>'>
                                </div>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>" 
                                              rows="3" placeholder="Add any additional notes..."><?php echo e(old('notes', $teacherAssignment->notes)); ?></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize selected students from hidden input
    let selectedStudents = JSON.parse(studentIdsInput.value || '[]');

    // Auto-fill department when course is selected
    document.getElementById('course_id').addEventListener('change', function() {
        const selectedOption = this.options[this.selectedIndex];
        const department = selectedOption.dataset.department;
        if (department && !document.getElementById('department').value) {
    ...
    function displayStudents(students) {
        ...
        students.forEach((student, index) => {
            const isSelected = selectedStudents.includes(student.id.toString());
            html += `
                <div class="col-md-6 mb-2">
                    <div class="student-item ${isSelected ? 'selected' : ''}">
                        <label class="d-flex align-items-center cursor-pointer">
                            <input type="checkbox" name="selected_students[]" value="${student.id}" 
                                   class="student-checkbox" data-name="${student.name}" ${isSelected ? 'checked' : ''}>
                            <div class="ms-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\teacher-assignments\edit.blade.php ENDPATH**/ ?>