    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-warning text-white">
                <div class="card-body text-center">
                    <div class="h4 mb-0"><?php echo e($statistics['without_heads']); ?></div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" class="course-checkbox" value="<?php echo e($course->id); ?>" onchange="updateBulkActions()">
                            </td>
                            <td>
                                <span class="badge bg-info"><?php echo e($course->program_code); ?></span>
                            </td>
                            <td>
                                <div class="fw-bold"><?php echo e($course->program_name); ?></div>
                                <?php if($course->description): ?>
                                    <small class="text-muted"><?php echo e(Str::limit($course->description, 50)); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <span class="badge bg-secondary"><?php echo e($course->department->department_name ?? 'N/A'); ?></span>
                            </td>
                            <td>
                                <?php if($course->head): ?>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-2">
                                            <?php echo e(strtoupper(substr($course->head->name, 0, 1))); ?>

                                        </div>
                                        <div>
                                            <div class="fw-bold"><?php echo e($course->head->name); ?></div>
                                            <small class="text-muted"><?php echo e($course->head->email); ?></small>
                                        </div>
                                    </div>
                                <?php else: ?>
                            ...
                            <td>
                                <span class="badge bg-light text-dark"><?php echo e($course->total_years); ?> Years</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="badge bg-light text-dark"><?php echo e($course->students_count ?? 0); ?></span>
                            </td>
                            <td>
                                <span class="badge bg-light text-dark"><?php echo e($course->classes_count ?? 0); ?></span>
                            </td>
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="<?php echo e(route('admin.courses.show', $course)); ?>" class="btn btn-sm btn-outline-info" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.courses.edit', $course)); ?>" class="btn btn-sm btn-outline-primary" title="Edit">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<?php echo e(route('admin.courses.manageSubjects', $course)); ?>">
                                                <i class="fas fa-book me-2"></i>Manage Subjects
                                            </a></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><a class="dropdown-item text-danger" href="#" onclick="deleteCourse(<?php echo e($course->id); ?>)">
                        ...
                        <tr>
                            <td colspan="10" class="text-center py-4">
                                ...
                                <a href="<?php echo e(route('admin.courses.create')); ?>" class="btn btn-primary mt-2">
...
function bulkAction(action) {
    ...
    fetch('<?php echo e(route("admin.courses.bulk-action")); ?>', {
        method: 'POST',
        headers: {
...
function deleteCourse(courseId) {
    ...
    form.method = 'POST';
    form.action = `<?php echo e(route('admin.courses.index')); ?>/${courseId}`;
    form.innerHTML = `
        <?php echo csrf_field(); ?>
...
function exportCourses(format) {
    ...
    window.open(`<?php echo e(route('admin.courses.export')); ?>?${params.toString()}`, '_blank');
}
</script>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/courses/index.blade.php ENDPATH**/ ?>