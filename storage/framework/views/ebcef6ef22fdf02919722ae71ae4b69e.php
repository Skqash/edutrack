...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-8">
            <form action="<?php echo e(route('admin.classes.update', $class)); ?>" method="POST" id="classForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="1" <?php echo e($class->class_level == '1' ? 'selected' : ''); ?>>1st Year</option>
                                        <option value="2" <?php echo e($class->class_level == '2' ? 'selected' : ''); ?>>2nd Year</option>
                                        <option value="3" <?php echo e($class->class_level == '3' ? 'selected' : ''); ?>>3rd Year</option>
                                        <option value="4" <?php echo e($class->class_level == '4' ? 'selected' : ''); ?>>4th Year</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="section" 
                                           name="section" value="<?php echo e($class->section); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="capacity" 
                                           name="capacity" value="<?php echo e($class->capacity); ?>" min="10" required>
...
unset($__errorArgs, $__bag); ?>" id="description" 
                                      name="description" rows="3"><?php echo e($class->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($course->id); ?>" 
                                                    ...
                                                    <?php echo e(old('course_id', $class->course_id) == $course->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="teacher_id" name="teacher_id" required>
                                        ...
                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($teacher->id); ?>" <?php echo e($class->teacher_id == $teacher->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" id="assignmentSection" style="display: none;">
                        <?php if($existingAssignments->isNotEmpty()): ?>
                            <div class="alert alert-info mb-3">
                                <h6><i class="fas fa-info-circle"></i> Current Assignments:</h6>
                                <ul class="mb-0">
                                    <?php $__currentLoopData = $existingAssignments->groupBy('teacher_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacherId => $assignments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <strong><?php echo e($assignments->first()->teacher->name); ?></strong> - 
                                            <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($assignment->subject): ?>
                                                    <span class="badge bg-success"><?php echo e($assignment->subject->subject_code); ?></span>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/classes/edit.blade.php ENDPATH**/ ?>