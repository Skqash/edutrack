                            ...
                            <tbody>
                                <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <div>
                                                <strong><?php echo e($request->user->name); ?></strong>
                                                <br><small class="text-muted"><?php echo e($request->user->email); ?></small>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="fw-semibold"><?php echo e($request->school_name); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge badge-modern bg-<?php echo e($request->status === 'approved' ? 'success' : ($request->status === 'rejected' ? 'danger' : 'secondary')); ?>">
                                        ...
                                        <td class="text-end">
                                            <a href="<?php echo e(route('admin.school-requests.show', $request)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/school_requests/index.blade.php ENDPATH**/ ?>