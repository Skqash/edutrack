                            ...
                            <?php if(isset($courses)): ?>
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($course->id); ?>"
                                        data-school="<?php echo e($course->college ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="presetAll">All Students</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="presetYear1">Year 1</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="presetYear2">Year 2</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="presetYear3">Year 3</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="presetYear4">Year 4</button>
                                    <button type="button" class="btn btn-sm btn-outline-info ms-auto" id="previewChangesBtn">
                                        <i class="fas fa-eye me-1"></i> Preview Changes
                                    </button>
                                </div>
                                <small class="form-text-modern">Use presets to auto-select students by year. Preview shows what will be updated before saving.</small>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="previewChangesModal" tabindex="-1" aria-labelledby="previewChangesModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        <strong>Note:</strong> Saving will update the selected students' assigned class, school, and department.
                    </div>
                    <div class="mb-3">
            ...
            function showPreview() {
                ...
                if (list) {
                    list.innerHTML = studentsPreview.length
                        ? studentsPreview.map(s => `<li class="list-group-item">${s.name} (${s.student_id})</li>`).join('')
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\teacher\classes\create.blade.php ENDPATH**/ ?>