    ...
    <div class="container-fluid p-4">
        ...
        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><strong><?php echo e($connection['database'] ?? 'edutrack_db'); ?></strong>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12 mb-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="mb-0"><i class="fas fa-table"></i> Table Statistics (<?php echo e(count($tables) ?? 0); ?> tables)
                        </h5>
                    </div>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $tables ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-end text-muted small">
                                            <?php echo e($table['collation'] ?? 'utf8mb4_unicode_ci'); ?></td>
                                    </tr>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress" style="height: 20px;">
                                <div class="progress-bar bg-primary"
                                    style="width: <?php echo e(min($storage['usage_percent'] ?? 0, 100)); ?>%">
                        ...
                        <table class="table table-sm mb-0">
                            <tr>
                                ...
                                <td class="text-end"><small
                                        class="text-muted"><?php echo e($storage['last_backup'] ?? 'Never'); ?></small></td>
                            </tr>
                            <tr>
                                <td>Last Optimization</td>
                                <td class="text-end"><small
                                        class="text-muted"><?php echo e($storage['last_optimize'] ?? 'Never'); ?></small></td>
                            </tr>
                            <tr>
            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-6">
                                <form action="<?php echo e(route('super.tools.optimize')); ?>" method="POST"
                            ...
                            <div class="col-md-6">
                                <form action="<?php echo e(route('super.tools.repair')); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\super\tools\database.blade.php ENDPATH**/ ?>