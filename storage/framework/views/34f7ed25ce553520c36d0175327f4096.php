        ...
        <div class="page-header-modern">
            <div class="header-content">
                ...
                <div class="header-actions">
                    ...
                    <a href="<?php echo e(route('admin.teachers.create')); ?>" class="btn btn-modern btn-modern-white">
            ...
            <div class="col-12">
                <div class="card card-modern">
                    <div class="card-header-modern">
                        ...
                        <span class="badge bg-warning"><?php echo e($teachers->total()); ?> Total</span>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted"><?php echo e($teacher->email); ?></span>
                                            </td>
                                            <td>
                                                <span class="text-muted"><?php echo e($teacher->created_at->format('d M Y')); ?></span>
                                            </td>
                                            <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\teachers.blade.php ENDPATH**/ ?>