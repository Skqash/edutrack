<?php $__env->startSection('content'); ?>
    <div class="container-fluid my-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="<?php echo e(route('teacher.assessment.configure.store', $class->id)); ?>" id="configForm">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="quiz_1_max"
                                                value="<?php echo e(old('quiz_1_max', $range->quiz_1_max ?? 25)); ?>" min="5"
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="quiz_2_max"
                                                value="<?php echo e(old('quiz_2_max', $range->quiz_2_max ?? 25)); ?>" min="5"
                                                max="100" required style="border-color: #0066cc;">
                                            <span class="input-group-text"
                                                style="background-color: #f0f7ff; border-color: #0066cc;">Pts</span>
                                        </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="quiz_3_max"
                                                value="<?php echo e(old('quiz_3_max', $range->quiz_3_max ?? 25)); ?>" min="5"
                                                max="100" required style="border-color: #0066cc;">
                                            <span class="input-group-text"
                                                style="background-color: #f0f7ff; border-color: #0066cc;">Pts</span>
                                        </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="quiz_4_max"
                                                value="<?php echo e(old('quiz_4_max', $range->quiz_4_max ?? 25)); ?>" min="5"
                                                max="100" required style="border-color: #0066cc;">
                                            <span class="input-group-text"
                                                style="background-color: #f0f7ff; border-color: #0066cc;">Pts</span>
                                        </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="quiz_5_max"
                                                value="<?php echo e(old('quiz_5_max', $range->quiz_5_max ?? 25)); ?>" min="5"
                                                max="100" required style="border-color: #0066cc;">
                                            <span class="input-group-text"
                                                style="background-color: #f0f7ff; border-color: #0066cc;">Pts</span>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="midterm_exam_max"
                                                value="<?php echo e(old('midterm_exam_max', $range->midterm_exam_max ?? 70)); ?>"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="final_exam_max"
                                                value="<?php echo e(old('final_exam_max', $range->final_exam_max ?? 80)); ?>"
                                                min="20" max="200" required style="border-color: #0066cc;">
                                            <span class="input-group-text"
                                                style="background-color: #f0f7ff; border-color: #0066cc;">Points</span>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="class_participation_midterm"
                                                value="<?php echo e(old('class_participation_midterm', $range->class_participation_midterm ?? 15)); ?>"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="class_participation_final"
                                                value="<?php echo e(old('class_participation_final', $range->class_participation_final ?? 15)); ?>"
                                                min="0" max="100" required style="border-color: #00a86b;"
                                                placeholder="e.g., 15 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #e8f8f0; border-color: #00a86b;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="activities_midterm"
                                                value="<?php echo e(old('activities_midterm', $range->activities_midterm ?? 15)); ?>"
                                                min="0" max="100" required style="border-color: #00a86b;"
                                                placeholder="e.g., 15 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #e8f8f0; border-color: #00a86b;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="activities_final"
                                                value="<?php echo e(old('activities_final', $range->activities_final ?? 15)); ?>"
                                                min="0" max="100" required style="border-color: #00a86b;"
                                                placeholder="e.g., 15 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #e8f8f0; border-color: #00a86b;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="assignments_midterm"
                                                value="<?php echo e(old('assignments_midterm', $range->assignments_midterm ?? 15)); ?>"
                                                min="0" max="100" required style="border-color: #00a86b;"
                                                placeholder="e.g., 15 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #e8f8f0; border-color: #00a86b;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="assignments_final"
                                                value="<?php echo e(old('assignments_final', $range->assignments_final ?? 15)); ?>"
                                                min="0" max="100" required style="border-color: #00a86b;"
                                                placeholder="e.g., 15 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #e8f8f0; border-color: #00a86b;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="output_midterm"
                                                value="<?php echo e(old('output_midterm', $range->output_midterm ?? 30)); ?>"
                                                min="0" max="100" required style="border-color: #00a86b;"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="output_final"
                                                value="<?php echo e(old('output_final', $range->output_final ?? 30)); ?>"
                                                min="0" max="100" required style="border-color: #00a86b;"
                                                placeholder="e.g., 30 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #e8f8f0; border-color: #00a86b;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="behavior_midterm"
                                                value="<?php echo e(old('behavior_midterm', $range->behavior_midterm ?? 5)); ?>"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="behavior_final"
                                                value="<?php echo e(old('behavior_final', $range->behavior_final ?? 5)); ?>"
                                                min="0" max="100" required style="border-color: #ff8c00;"
                                                placeholder="e.g., 5 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #fff3e0; border-color: #ff8c00;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="awareness_midterm"
                                                value="<?php echo e(old('awareness_midterm', $range->awareness_midterm ?? 5)); ?>"
                                                min="0" max="100" required style="border-color: #ff8c00;"
                                                placeholder="e.g., 5 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #fff3e0; border-color: #ff8c00;">Pts</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="awareness_final"
                                                value="<?php echo e(old('awareness_final', $range->awareness_final ?? 5)); ?>"
                                                min="0" max="100" required style="border-color: #ff8c00;"
                                                placeholder="e.g., 5 for 3 entries">
                                            <span class="input-group-text"
                                                style="background-color: #fff3e0; border-color: #ff8c00;">Pts</span>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="attendance_required"
                                            ...
                                            <?php echo e(old('attendance_required', $range->attendance_required ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="attendance_min_percentage"
                                            value="<?php echo e(old('attendance_min_percentage', $range->attendance_min_percentage ?? 75)); ?>"
                    ...
                    <div class="card shadow-sm mb-4" style="border-top: 4px solid #6c757d;">
                        ...
                        <div class="card-body">
                            <textarea class="form-control" name="notes" rows="3"
                                ...
                                style="border-color: #6c757d;"><?php echo e(old('notes', $range->notes ?? '')); ?></textarea>
                    ...
                    <div class="d-flex gap-3 mb-4">
                        ...
                        <a href="<?php echo e(route('teacher.dashboard')); ?>" class="btn btn-lg fw-bold"
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/teacher/assessment/configure_enhanced.blade.php ENDPATH**/ ?>