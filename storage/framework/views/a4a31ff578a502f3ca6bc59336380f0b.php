...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.searchable-dropdown','data' => ['name' => 'student_id','id' => 'student_id','placeholder' => 'All Students','apiUrl' => ''.e(route('api.students')).'','selected' => $studentId ?? '','clearable' => true,'class' => 'form-select']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'student_id','id' => 'student_id','placeholder' => 'All Students','api-url' => ''.e(route('api.students')).'','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($studentId ?? ''),'clearable' => true,'class' => 'form-select']); ?>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($att->student->name ?? 'N/A'); ?></td>
                                <td>
                                    <span
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/teacher/attendance/history.blade.php ENDPATH**/ ?>