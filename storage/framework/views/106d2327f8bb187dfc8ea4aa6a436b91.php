    ...
    <div class="grade-result-container p-4">
        ...
        <div class="page-header">
            ...
            <?php if(!empty($selectedClass)): ?>
                <p class="page-subtitle"><strong>Showing results for:</strong> <?php echo e($selectedClass->class_name); ?>

                    (<?php echo e($selectedClass->course->course_name ?? 'Course'); ?>)</p>
            <?php endif; ?>
                ...
                <div class="card class-card">
                    ...
                    <div class="class-header">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h3 class="class-title"><?php echo e($classResult['class']->class_name); ?></h3>
                            ...
                            <span
                                class="badge bg-primary"><?php echo e($classResult['stats']['graded_students']); ?>/<?php echo e($classResult['stats']['total_students']); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $classResult['students']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr data-student-id="<?php echo e($result['student_id']); ?>">
                                            ...
                                            <!-- Midterm Grade -->
                                            <td class="grade-cell">
                                                <div style="margin-bottom: 0.3rem;"><?php echo e($result['midterm_grade']); ?></div>
                                                <span class="decimal-grade"><?php echo e($result['midterm_decimal']); ?></span>
                                            </td>

                                            <!-- Final Grade -->
                                            <td class="grade-cell">
                                                <div style="margin-bottom: 0.3rem;"><?php echo e($result['final_grade']); ?></div>
                                            ...
                                            <td class="grade-cell">
                                                <div style="margin-bottom: 0.3rem; font-weight: 700;">
                                                    <?php echo e($result['overall_grade']); ?></div>
                                                <span class="decimal-grade"
                                                    style="min-width: 50px;"><?php echo e($result['decimal_grade']); ?></span>
                                            </td>
                                            ...
                                            <td class="grade-cell">
                                                ...
                                                ?>
                                                <span
                                                    class="letter-grade-badge <?php echo e($gradeClass); ?>"><?php echo e($letterGrade); ?></span>
                                            </td>

                                            <!-- Status -->
                                            <td>
                                                <span
                                                    class="status-badge <?php if($result['status'] === 'Passed'): ?> status-passed <?php else: ?> status-failed <?php endif; ?>">
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\teacher\grades\grade_results.blade.php ENDPATH**/ ?>