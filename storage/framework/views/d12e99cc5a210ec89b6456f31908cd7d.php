        ...
        <div class="col-lg-8">
            <div class="card form-card">
                <div class="card-body p-4">
                    <form action="<?php echo e(route('admin.profile.update')); ?>" method="PUT">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('department', $admin->department ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>" id="bio" name="bio" rows="4"
                                    placeholder="Tell about your role and experience..."><?php echo e(old('bio', $admin->bio ?? '')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\profile\edit.blade.php ENDPATH**/ ?>