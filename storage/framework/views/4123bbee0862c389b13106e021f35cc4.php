        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a href="<?php echo e(route('admin.profile.edit')); ?>" class="btn btn-light me-2">
                        <i class="fas fa-edit me-2"></i> Edit Profile
                    </a>
                    <a href="<?php echo e(route('admin.profile.change-password')); ?>" class="btn btn-outline-light">
                ...
                <div class="card-body">
                    ...
                    <?php if($admin): ?>
                        <div class="info-group">
                            ...
                            <div class="info-value">
                                <?php echo e($admin->department ?? 'Not specified'); ?>
        ...
        <div class="col-lg-4">
            ...
            <div class="card profile-card">
                <div class="card-body">
                    ...
                    <div class="action-buttons">
                        <a href="<?php echo e(route('admin.profile.edit')); ?>" class="btn btn-sm btn-success">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-sm btn-outline-success">
            ...
            <div class="card profile-card">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="<?php echo e(route('admin.classes.index')); ?>" class="list-group-item list-group-item-action">
                        <i class="fas fa-door-open me-2 text-success"></i> Classes
                    </a>
                    <a href="<?php echo e(route('admin.profile.change-password')); ?>" class="list-group-item list-group-item-action">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/profile/show.blade.php ENDPATH**/ ?>