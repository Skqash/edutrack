<?php $__env->startSection('content'); ?>
    <div class="container-fluid p-4">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="student-row" data-class="<?php echo e($student->class_id ?? ''); ?>">
                                ...
                                <td><?php echo e($student->enrollment_date ? $student->enrollment_date->format('M d, Y') : 'N/A'); ?>

                                </td>
                                <td>
                                    <button class="btn btn-sm btn-warning"
                                        onclick="editStudent(<?php echo e($student->id); ?>)">Edit</button>
        ...
        <div class="mt-3">
            <form action="<?php echo e(route('super.students.delete-all')); ?>" method="POST"
