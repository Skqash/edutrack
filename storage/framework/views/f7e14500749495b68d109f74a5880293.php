                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h4 class="text-primary mb-0"><?php echo e($totalUsers ?? 0); ?></h4>
                                <small class="text-success"><?php echo e($totalAdmins + $totalTeachers + $totalStudents); ?>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h4 class="text-danger mb-0"><?php echo e($totalAdmins ?? 0); ?></h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h4 class="text-success mb-0"><?php echo e($totalTeachers ?? 0); ?></h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h4 class="text-info mb-0"><?php echo e($totalStudents ?? 0); ?></h4>
            ...
            <div class="col-lg-2 col-md-4 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-warning mb-0"><?php echo e($totalCourses ?? 0); ?></h4>
                        <small class="text-success"><?php echo e($activeCourses ?? 0); ?> Active</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-purple mb-0"><?php echo e($totalClasses ?? 0); ?></h4>
                        <small class="text-success"><?php echo e($activeClasses ?? 0); ?> Active</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-secondary mb-0"><?php echo e($totalSubjects ?? 0); ?></h4>
            ...
            <div class="col-lg-2 col-md-4 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-info mb-0"><?php echo e($totalCapacity ?? 0); ?></h4>
            ...
            <div class="col-lg-2 col-md-4 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-success mb-0"><?php echo e($totalEnrolled ?? 0); ?></h4>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-warning mb-0">
                            <?php echo e($totalCapacity > 0 ? round(($totalEnrolled / $totalCapacity) * 100) : 0); ?>%</h4>
                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('super.users.create')); ?>" class="btn btn-sm btn-primary">
                                <i class="fas fa-user-plus"></i> New User
                            </a>
                            <a href="<?php echo e(route('super.courses.create')); ?>" class="btn btn-sm btn-warning">
                                <i class="fas fa-book"></i> New Course
                            </a>
                            <a href="<?php echo e(route('super.students.create')); ?>" class="btn btn-sm btn-info">
                                <i class="fas fa-graduation-cap"></i> Add Student
                            </a>
                            <a href="<?php echo e(route('super.health')); ?>" class="btn btn-sm btn-success">
                                <i class="fas fa-heartbeat"></i> System Health
                            </a>
                            <a href="<?php echo e(route('super.tools.backup')); ?>" class="btn btn-sm btn-secondary">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.users.index')); ?>"
                                    ...
                                    <span class="badge bg-primary ms-2"><?php echo e($totalUsers ?? 0); ?></span>
                                </a>
                            </div>

                            <!-- Students Management -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.students.index')); ?>"
                                    class="btn btn-outline-info btn-sm w-100 py-2">
                                    <i class="fas fa-graduation-cap"></i> Students
                                    <span class="badge bg-info ms-2"><?php echo e($totalStudents ?? 0); ?></span>
                                </a>
                            </div>

                            <!-- Courses Management -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.courses.index')); ?>"
                                    class="btn btn-outline-warning btn-sm w-100 py-2">
                                    <i class="fas fa-book"></i> Courses
                                    <span class="badge bg-warning ms-2"><?php echo e($totalCourses ?? 0); ?></span>
                                </a>
                            </div>

                            <!-- Classes Management -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.classes.index')); ?>"
                                    class="btn btn-outline-purple btn-sm w-100 py-2">
                                    <i class="fas fa-chalkboard"></i> Classes
                                    <span class="badge bg-purple ms-2"><?php echo e($totalClasses ?? 0); ?></span>
                                </a>
                            </div>

                            <!-- Grades Management -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.grades.index')); ?>"
                            ...
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.attendance.index')); ?>"
                            ...
                            <!-- Database Tools -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.tools.database')); ?>"
                            ...
                            <!-- System Tools -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.health')); ?>" class="btn btn-outline-info btn-sm w-100 py-2">
                            ...
                            <!-- Logs -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.logs.view')); ?>" class="btn btn-outline-dark btn-sm w-100 py-2">
                            ...
                            <!-- Cleanup -->
                            <div class="col-md-3">
                                <a href="<?php echo e(route('super.cleanup')); ?>" class="btn btn-outline-danger btn-sm w-100 py-2">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-light border-0 py-3 d-flex justify-content-between">
                        ...
                        <a href="<?php echo e(route('super.users.index')); ?>" class="btn btn-link btn-sm">View All</a>
                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="small"><?php echo e(Str::limit($user->name, 15)); ?></span>
                                                </div>
                                            </td>
                                            <td class="small"><?php echo e(Str::limit($user->email, 20)); ?></td>
                                            <td>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-light border-0 py-3 d-flex justify-content-between">
                        ...
                        <a href="<?php echo e(route('super.courses.index')); ?>" class="btn btn-link btn-sm">View All</a>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $recentCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="small"><?php echo e(Str::limit($course->course_name, 20)); ?></td>
                                            <td class="small"><code><?php echo e($course->course_code); ?></code></td>
                                            <td class="small">
                                                <?php echo e($course->instructor ? Str::limit($course->instructor->name, 15) : '-'); ?>

                                            </td>
                                            <td class="text-muted small"><?php echo e($course->created_at->diffForHumans()); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
        ...
        if (userDistributionCtx) {
            new Chart(userDistributionCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo e($totalAdmins ?? 0); ?>, <?php echo e($totalTeachers ?? 0); ?>,
        ...
        if (courseStatusCtx) {
            new Chart(courseStatusCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Courses',
                        data: [<?php echo e($totalCourses ?? 0); ?>, <?php echo e($activeCourses ?? 0); ?>,
                            <?php echo e($totalCourses - $activeCourses ?? 0); ?>
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            beginAtZero: true,
                            max: Math.max(<?php echo e($totalCourses ?? 0); ?> + 5, 10)
                        }
                    }
                }
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\super\dashboard_optimized.blade.php ENDPATH**/ ?>