                ...
                <div class="card-body overflow-hidden" style="padding-top: 1.5rem;">
                    ...
                    <?php else: ?>
                        <div class="alert alert-warning">
                            ...
                            <a href="<?php echo e(route('teacher.assessment.configure', $class->id)); ?>" class="alert-link">Configure
                                assessment ranges</a>
                                    ...
                                    <tr data-student-id="<?php echo e($student->id); ?>">
                                        ...
                                        <?php if($term == 'midterm'): ?>
                                            <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                    data-min="0" data-max="<?php echo e($range->midterm_exam_max ?? 100); ?>"
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0"
                                                data-max="<?php echo e($range->quiz_1_max ?? 25); ?>"
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0"
                                                data-max="<?php echo e($range->quiz_2_max ?? 25); ?>"
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0"
                                                data-max="<?php echo e($range->quiz_3_max ?? 25); ?>"
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0"
                                                data-max="<?php echo e($range->quiz_4_max ?? 25); ?>"
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0"
                                                data-max="<?php echo e($range->quiz_5_max ?? 25); ?>"
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0"
                                                data-max="<?php echo e($range->attendance_max ?? 100); ?>"
