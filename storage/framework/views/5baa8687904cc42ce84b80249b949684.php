...
<body>
    ...
    <div class="sidebar shadow-sm" id="sidebar">
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.students*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.students.index')); ?>"><i class="bi bi-mortarboard me-2"></i>
                    <span>Students</span></a></li>
            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.teachers*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.teachers.index')); ?>"><i class="bi bi-person-badge me-2"></i>
                    <span>Teachers</span></a></li>
            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.courses*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.courses.index')); ?>"><i class="bi bi-award me-2"></i> <span>Courses</span></a>
            </li>
            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.classes*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.classes.index')); ?>"><i class="bi bi-house-door me-2"></i>
                    <span>Classes</span></a></li>

            <div class="section-title">Academic</div>

            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.subjects*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.subjects.index')); ?>"><i class="bi bi-book me-2"></i>
                    <span>Subjects</span></a></li>
            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.attendance*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.attendance.index')); ?>"><i class="bi bi-check2-square me-2"></i>
                    <span>Attendance</span></a></li>
            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.grades*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.grades.index')); ?>"><i class="bi bi-bar-chart-line me-2"></i>
                    <span>Grades</span></a></li>

            <div class="section-title">System</div>

            <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('admin.users*') ? 'active' : ''); ?>"
                    href="<?php echo e(route('admin.users.index')); ?>"><i class="bi bi-people me-2"></i> <span>User
            ...
            <div class="d-flex align-items-center gap-2 gap-md-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end"
                                ...
                                <a class="dropdown-item border-bottom py-2" href="<?php echo e($notif->action_url ?? '#'); ?>">
                                    <div class="d-flex gap-2">
                                        <span class="badge bg-<?php echo e($notif->type); ?> rounded-circle">
                                            <i class="bi bi-<?php echo e($notif->icon ?? 'bell'); ?>"></i>
                                        </span>
                        ...
                        <?php if(count($notifications) > 0): ?>
                            ...
                            <li><a class="dropdown-item text-center small"
                                    href="<?php echo e(route('notifications.index')); ?>">View All</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="dropdown">
                    <button class="btn btn-outline-success dropdown-toggle btn-sm" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-sm-inline"><?php echo e(auth()->user()->name ?? 'Admin'); ?></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.profile.show')); ?>">
                ...
                <div class="col-6 col-md-3">
                    <div class="card stat-card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h3 class="text-success mb-0"><?php echo e($totalStudents ?? '0'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="card stat-card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h3 class="text-primary mb-0"><?php echo e($totalTeachers ?? '0'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="card stat-card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h3 class="text-warning mb-0"><?php echo e($totalClasses ?? '0'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="card stat-card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h3 class="text-danger mb-0"><?php echo e($totalSubjects ?? '0'); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
