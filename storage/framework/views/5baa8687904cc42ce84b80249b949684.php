            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.teachers.campus-approvals')); ?>"
                        ...
                        <?php if($pendingCampusApprovals > 0): ?>
                            <span class="badge bg-warning text-dark ms-auto"><?php echo e($pendingCampusApprovals); ?></span>
                        <?php endif; ?>
                    </a>
                </div>

                <div class="nav-item">
                    <a href="<?php echo e(route('admin.teachers.course-access-requests')); ?>"
                        class="nav-link <?php echo e(request()->routeIs('admin.teachers.course-access-requests') ? 'active' : ''); ?>">
                        <i class="fas fa-graduation-cap"></i>
                        <span>Course Access</span>
                        <?php if($pendingCourseRequests > 0): ?>
                            <span class="badge bg-info ms-auto"><?php echo e($pendingCourseRequests); ?></span>
                        <?php endif; ?>
                    </a>
                </div>
