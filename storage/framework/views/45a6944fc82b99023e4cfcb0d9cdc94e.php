        ...
        <div class="row mb-3">
            <div class="col-auto">
                ...
                <select id="attendanceTermSelect" class="form-select form-select-sm">
                    <option value="Midterm" <?php echo e($currentTerm === 'Midterm' ? 'selected' : ''); ?>>Midterm</option>
                    <option value="Final" <?php echo e($currentTerm === 'Final' ? 'selected' : ''); ?>>Final</option>
                </select>
            </div>
            <div class="col-auto">
                <label class="form-label small mb-1">Date</label>
                <input type="date" id="attendanceDateFilter" class="form-control form-control-sm"
                    value="<?php echo e($today); ?>" max="<?php echo e(now()->format('Y-m-d')); ?>">
            </div>
        </div>
                                ...
                                <?php else: ?>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <span class="badge bg-success"><?php echo e($classAttendanceStats['Present']); ?>

                                                Present</span>
                                            <span class="badge bg-danger"><?php echo e($classAttendanceStats['Absent']); ?>

                                                Absent</span>
                                            <span class="badge bg-warning"><?php echo e($classAttendanceStats['Late']); ?> Late</span>
                                            <span class="badge bg-primary"><?php echo e($classAttendanceStats['Leave']); ?>

                                                Excused</span>
                                            <span class="badge bg-secondary"><?php echo e($classAttendanceStats['Unmarked']); ?>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="badge rounded-circle"
                                                                    ...
                                                                    <?php echo e(strtoupper(substr($student->first_name ?? 'U', 0, 1))); ?>
