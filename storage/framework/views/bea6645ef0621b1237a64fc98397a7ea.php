                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold text-muted">
                                <?php echo e(round($totalStudents > 0 ? ($gradesPosted / $totalStudents) * 100 : 0, 0)); ?>%</h2>
                        </div>
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card feature-card h-100 shadow-sm">
                <div class="card-body text-center d-flex flex-column">
                    ...
                    <a href="<?php echo e(route('teacher.grades')); ?>" class="btn btn-sm fw-bold text-white mt-3"
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card feature-card h-100 shadow-sm">
                <div class="card-body text-center d-flex flex-column">
                    ...
                    <?php if($myClasses && $myClasses->count() > 0): ?>
                        <a href="<?php echo e(route('teacher.assessment.configure', $myClasses->first()->id)); ?>"
                                ...
                                <?php if($myClasses && $myClasses->count() > 0): ?>
                                    <?php $__empty_1 = true; $__currentLoopData = $myClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="ps-3">
                                                <strong
                                                    class="text-primary d-block"><?php echo e($class->class_name ?? 'N/A'); ?></strong>
                                                <small class="text-muted"><?php echo e($class->course->course_name ?? 'Course'); ?></small>
                                            </td>
                                            <td>
                                                <span class="badge text-white" style="background-color: #0066cc;">
                                                    <?php echo e($class->section ?? 'Year 1'); ?>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <a href="<?php echo e(route('teacher.grades.entry', $class->id)); ?>?term=midterm"
                                                        class="btn fw-bold text-white"
                                                        style="background-color: #00a86b; border: none;" title="Entry">  
                                                        <i class="fas fa-keyboard"></i>
                                                    </a>
                                                    <a href="<?php echo e(route('teacher.grades.analytics', $class->id)); ?>"
                                                        class="btn fw-bold text-white"
            ...
            <div class="card h-100">
                <div class="card-header bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('admin.courses.create')); ?>" class="btn btn-sm fw-bold text-white"
                            style="background-color: #0066cc; border: none;">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $myCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="ps-3">
                                                ...
                                                <small class="text-muted"><?php echo e($course->description ?? 'No description'); ?></small>
                                            </td>
                                            ...
                                            <td class="d-none d-lg-table-cell">
                                                <small class="text-muted"><?php echo e($course->department ?? 'General'); ?></small>
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $recentGrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><small class="text-muted"><?php echo e($classData->course_name ?? 'N/A'); ?></small></td>
                                            <td class="text-center">
...
unset($__errorArgs, $__bag); ?>" id="courseId"
                                    ...
                                    <?php if(!empty($myClasses)): ?>
                                        <?php $__currentLoopData = $myClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($class->course_id); ?>"><?php echo e($class->course->course_name ?? 'N/A'); ?>
