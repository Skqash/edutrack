            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <div class="row g-2">
                        ...
                        <!-- Database Backup -->
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <a href="<?php echo e(route('super.tools.backup')); ?>" class="btn btn-outline-danger w-100 py-3" onclick="return confirm('Download database backup?')">
                        ...
                        <!-- Clear Caches -->
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <form action="<?php echo e(route('super.system.cache-clear')); ?>" method="POST" style="display:inline; width: 100%;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-outline-dark w-100 py-3" onclick="return confirm('Clear all caches?')">
                        ...
                        <!-- Run Migrations -->
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <form action="<?php echo e(route('super.system.migrate')); ?>" method="POST" style="display:inline; width: 100%;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-outline-primary w-100 py-3" onclick="return confirm('Run database migrations?')">
                        ...
                        <!-- Run Seeders -->
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <form action="<?php echo e(route('super.system.seed')); ?>" method="POST" style="display:inline; width: 100%;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-outline-success w-100 py-3" onclick="return confirm('Reseed database with test data?')">
