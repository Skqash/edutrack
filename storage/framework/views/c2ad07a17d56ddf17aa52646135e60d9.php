<?php $__env->startSection('content'); ?>
    <div class="container-fluid p-4">
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-danger alert-dismissible fade show"><?php echo e(session('error')); ?><button class="btn-close"
                    data-bs-dismiss="alert"></button></div>
        <?php endif; ?>
                    ...
                    <div class="card-body">
                        <table class="table table-sm mb-0">
                            ...
                            <tr>
                                ...
                                <td><span
                                        class="badge bg-<?php echo e($health['logs']['error_count'] > 0 ? 'warning' : 'success'); ?>"><?php echo e($health['logs']['error_count']); ?></span>
                                </td>
                            </tr>
                        </table>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\super\tools\health.blade.php ENDPATH**/ ?>