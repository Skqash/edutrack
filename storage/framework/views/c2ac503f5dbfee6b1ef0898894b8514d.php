        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="btn-group" role="group">
                    <a href="<?php echo e(route('admin.classes.edit', $class->id)); ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit me-1"></i> Edit
                    </a>
                    <a href="<?php echo e(route('admin.classes.index')); ?>" class="btn btn-outline-secondary btn-sm">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <button type="button" class="btn btn-outline-danger"
                                                        ...
                                                        onclick="removeStudent(<?php echo e($student->id); ?>)">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views\admin\classes\show.blade.php ENDPATH**/ ?>