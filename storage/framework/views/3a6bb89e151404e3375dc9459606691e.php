...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['total_teachers']['total'] ?? 0); ?></div>
                            <div class="text-xs text-muted">
                                <span class="text-success"><?php echo e($stats['total_teachers']['approved'] ?? 0); ?> approved</span> |
                                <span class="text-warning"><?php echo e($stats['total_teachers']['pending'] ?? 0); ?> pending</span>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['total_courses'] ?? 0); ?></div>
                        </div>
                        <div class="col-auto">
    ...
    <?php if(($stats['pending_approvals']['campus_approvals'] ?? 0) > 0 || ($stats['pending_approvals']['course_requests'] ?? 0) > 0): ?>
    <div class="alert alert-warning alert-dismissible fade show mb-4" role="alert">
        <i class="fas fa-exclamation-triangle me-2"></i>
        <strong>Pending Approvals:</strong>
        <?php if(($stats['pending_approvals']['campus_approvals'] ?? 0) > 0): ?>
            <a href="<?php echo e(route('admin.teachers.campus-approvals')); ?>" class="alert-link">
                <?php echo e($stats['pending_approvals']['campus_approvals']); ?> campus approval<?php echo e($stats['pending_approvals']['campus_approvals'] > 1 ? 's' : ''); ?>

            </a>
        <?php endif; ?>
        <?php if(($stats['pending_approvals']['course_requests'] ?? 0) > 0): ?>
            <?php if(($stats['pending_approvals']['campus_approvals'] ?? 0) > 0): ?> and <?php endif; ?>
            <a href="<?php echo e(route('admin.teachers.course-access-requests')); ?>" class="alert-link">
                <?php echo e($stats['pending_approvals']['course_requests']); ?> course request<?php echo e($stats['pending_approvals']['course_requests'] > 1 ? 's' : ''); ?>
                    ...
                    <div id="recentActivitiesContainer">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="small text-gray-800"><?php echo e($activity['message']); ?></div>
                                <div class="small text-muted"><?php echo e(\Carbon\Carbon::parse($activity['timestamp'])->diffForHumans()); ?></div>
                            </div>
                        </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('admin.teachers.create')); ?>" class="btn btn-primary btn-sm">
                            <i class="fas fa-plus me-2"></i>Add Teacher
                        </a>
                        <a href="<?php echo e(route('admin.students.create')); ?>" class="btn btn-success btn-sm">
                            <i class="fas fa-plus me-2"></i>Add Student
                        </a>
                        <a href="<?php echo e(route('admin.classes.create')); ?>" class="btn btn-info btn-sm">
                            <i class="fas fa-plus me-2"></i>Create Class
                        </a>
                        <a href="<?php echo e(route('admin.courses.create')); ?>" class="btn btn-warning btn-sm">
                            <i class="fas fa-plus me-2"></i>Add Course
                        </a>
                        <hr>
                        <a href="<?php echo e(route('admin.teachers.campus-approvals')); ?>" class="btn btn-outline-warning btn-sm">
                            <i class="fas fa-building me-2"></i>Campus Approvals
                            <?php if(($stats['pending_approvals']['campus_approvals'] ?? 0) > 0): ?>
                                <span class="badge bg-warning"><?php echo e($stats['pending_approvals']['campus_approvals']); ?></span>
                            <?php endif; ?>
                        </a>
                        <a href="<?php echo e(route('admin.teachers.course-access-requests')); ?>" class="btn btn-outline-info btn-sm">
                            <i class="fas fa-graduation-cap me-2"></i>Course Requests
                            <?php if(($stats['pending_approvals']['course_requests'] ?? 0) > 0): ?>
                                <span class="badge bg-info"><?php echo e($stats['pending_approvals']['course_requests']); ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                </div>
...
function initializeCharts() {
    ...
    const enrollmentData = <?php echo json_encode($chartData['enrollment'] ?? [], 15, 512) ?>;
    ...
    const gradeData = <?php echo json_encode($chartData['grades'] ?? [], 15, 512) ?>;
...
function exportData(type, format) {
    const url = `<?php echo e(route('admin.dashboard')); ?>/export?type=${type}&format=${format}`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edutrack\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>