    ...
    <div class="page-header-modern">
        <div class="header-content">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('admin.classes.create')); ?>" class="btn btn-modern btn-modern-white">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $classesByCourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courseName => $courseClasses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <!-- Course Header Row -->
                            <tr class="table-primary">
                                <td colspan="8" class="fw-bold">
                                    ...
                                    <span class="badge bg-primary ms-2"><?php echo e($courseClasses->count()); ?> classes</span>
                                </td>
                            </tr>
                                ...
                                <tr data-class-id="<?php echo e($class->id); ?>">
                                    ...
                                    <td>
                                        <span class="badge bg-light text-dark">
                                            Year <?php echo e($class->year); ?>-<?php echo e(strtoupper($class->section)); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($class->school_year ?? 'N/A'); ?></td>
                                    <td>
                                        <span class="badge bg-info text-white">
                                            Semester <?php echo e($class->semester ?? '1'); ?>

                                        </span>
                                    </td>
                                    <td><span class="badge bg-success"><?php echo e($class->total_students ?? 0); ?></span></td>
                                    ...
                                    <td>
                                        <div class="progress" style="height: 20px; width: 100px;">
                                            ...
                                            <div class="progress-bar <?php echo e($barClass); ?>"
                                                style="width: <?php echo e($percentage); ?>%; title='<?php echo e($enrolled); ?>/<?php echo e($capacity); ?> students'">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
