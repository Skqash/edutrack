...
<div class="p-4">
        ...
        <div class="row align-items-center">
            <div class="col-md-10">
                <h6 class="mb-2">
                    ...
                    Grade Entry for <?php echo e(ucfirst($term)); ?> Term - <?php echo e($class->class_name); ?>
    ...
    <?php if($knowledgeComponents->isEmpty() && $skillsComponents->isEmpty() && $attitudeComponents->isEmpty()): ?>
                    ...
                    <table class="table table-hover mb-0 table-fixed" id="gradeTable" style="min-width: 1200px;">
                        <thead class="table-light sticky-top" style="position: sticky; top: 0; z-index: 10; background: white;">
                            <tr>
                                ...
                                <?php if($knowledgeComponents->count() > 0): ?>
                                    <?php
                                        $examCount = $knowledgeComponents->where('subcategory', 'Exam')->count();
                                        $quizCount = $knowledgeComponents->where('subcategory', 'Quiz')->count();
                                    ?>
                                    <th colspan="<?php echo e($examCount + ($examCount > 0 ? 1 : 0) + $quizCount + ($quizCount > 0 ? 1 : 0) + 1); ?>" class="text-center bg-primary text-white">
                                        <i class="fas fa-brain me-1"></i>Knowledge (40%)
                                    </th>
                                <?php endif; ?>
                                
                                <?php if($skillsComponents->count() > 0): ?>
                                    <?php
                                    ...
                                    ?>
                                    <th colspan="<?php echo e($outputCount + ($outputCount > 0 ? 1 : 0) + $cpCount + ($cpCount > 0 ? 1 : 0) + $activityCount + ($activityCount > 0 ? 1 : 0) + $assignmentCount + ($assignmentCount > 0 ? 1 : 0) + 1); ?>" class="text-center bg-success text-white">
                                        <i class="fas fa-tools me-1"></i>Skills (50%)
                                    </th>
                                <?php endif; ?>
                                
                                <?php if($attitudeComponents->count() > 0): ?>
                                    <?php
                                    ...
                                    ?>
                                    <th colspan="<?php echo e($behaviorCount + ($behaviorCount > 0 ? 1 : 0) + $awarenessCount + ($awarenessCount > 0 ? 1 : 0) + 1); ?>" class="text-center bg-warning text-white">
                            ...
                            <tr>
                                ...
                                <?php $__currentLoopData = $knowledgeComponents->where('subcategory', 'Exam'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-primary bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($knowledgeComponents->where('subcategory', 'Exam')->count() > 0): ?>
                                    <th class="text-center bg-primary bg-opacity-25">
                                        <strong>Exam Ave</strong>
                                    </th>
                                <?php endif; ?>
                                
                                <?php $__currentLoopData = $knowledgeComponents->where('subcategory', 'Quiz'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-primary bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($knowledgeComponents->where('subcategory', 'Quiz')->count() > 0): ?>
                                    <th class="text-center bg-primary bg-opacity-25">
                                ...
                                <?php $__currentLoopData = $skillsComponents->where('subcategory', 'Output'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-success bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($skillsComponents->where('subcategory', 'Output')->count() > 0): ?>
                                    <th class="text-center bg-success bg-opacity-25">
                                        <strong>Output Ave</strong>
                                    </th>
                                <?php endif; ?>
                                
                                <?php $__currentLoopData = $skillsComponents->where('subcategory', 'Participation'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-success bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($skillsComponents->where('subcategory', 'Participation')->count() > 0): ?>
                                    <th class="text-center bg-success bg-opacity-25">
                                        <strong>CP Ave</strong>
                                    </th>
                                <?php endif; ?>
                                
                                <?php $__currentLoopData = $skillsComponents->where('subcategory', 'Activity'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-success bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($skillsComponents->where('subcategory', 'Activity')->count() > 0): ?>
                                    <th class="text-center bg-success bg-opacity-25">
                                        <strong>Activity Ave</strong>
                                    </th>
                                <?php endif; ?>
                                
                                <?php $__currentLoopData = $skillsComponents->where('subcategory', 'Assignment'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-success bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($skillsComponents->where('subcategory', 'Assignment')->count() > 0): ?>
                                    <th class="text-center bg-success bg-opacity-25">
                                ...
                                <?php $__currentLoopData = $attitudeComponents->where('subcategory', 'Behavior'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-warning bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($attitudeComponents->where('subcategory', 'Behavior')->count() > 0): ?>
                                    <th class="text-center bg-warning bg-opacity-25">
                                        <strong>Behavior Ave</strong>
                                    </th>
                                <?php endif; ?>
                                
                                <?php $__currentLoopData = $attitudeComponents->where('subcategory', 'Awareness'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center bg-warning bg-opacity-10">
                                        <?php echo e($component->name); ?><br>
                                        <small>(<?php echo e($component->weight); ?>%)</small>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($attitudeComponents->where('subcategory', 'Awareness')->count() > 0): ?>
                                    <th class="text-center bg-warning bg-opacity-25">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $class->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr data-student-id="<?php echo e($student->id); ?>">
                                    <td class="fw-semibold student-name-cell">
                                        <div class="student-name"><?php echo e(trim(($student->first_name ?? '') . ' ' . ($student->last_name ?? '')) ?: 'N/A'); ?></div>
                                        <div class="student-id-number"><?php echo e($student->student_id ?? 'N/A'); ?></div>
                                    </td>
                                    ...
                                    <?php $__currentLoopData = $knowledgeComponents->where('subcategory', 'Exam'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td>
                                            ...
                                            <input type="number" 
                                                   ...
                                                   data-weight="<?php echo e($component->weight); ?>"
                                                   data-max="<?php echo e($component->max_score); ?>"
                                                   data-passing="<?php echo e($component->passing_score ?? 0); ?>"
                                                   min="0" 
                                                   max="<?php echo e($component->max_score); ?>" 
                                                   step="0.01"
                                                   value="<?php echo e($existingScore); ?>"
                                                   placeholder="<?php echo e($component->max_score); ?>">
                                        </td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($knowledgeComponents->where('subcategory', 'Exam')->count() > 0): ?>
...
function calculateAllGrades() {
    ...
    rows.forEach(row => {
        ...
        const kWeight = <?php echo e($ksaSettings->knowledge_weight ?? 0.4); ?>;
        const sWeight = <?php echo e($ksaSettings->skills_weight ?? 0.5); ?>;
        const aWeight = <?php echo e($ksaSettings->attitude_weight ?? 0.1); ?>;
...
<?php /**PATH C:\laragon\www\edutrack\resources\views/teacher/grades/advanced_grade_entry_embedded.blade.php ENDPATH**/ ?>