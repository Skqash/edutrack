<?php $__env->startSection('content'); ?>
    <div class="container-fluid p-4">
        ...
        <?php if(session('success')): ?>
            <div class="alert alert-success alert-dismissible fade show"><?php echo e(session('success')); ?><button class="btn-close"
                ...
                <table class="table table-hover mb-0" id="attendanceTable">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $attendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="attendance-row" data-class="<?php echo e($record->class_id ?? ''); ?>"
                                data-date="<?php echo e($record->date ?? ''); ?>" data-status="<?php echo e($record->status ?? ''); ?>">
                                ...
                                <td>
                                    <span
                                        class="badge bg-<?php echo e($record->status === 'present' ? 'success' : ($record->status === 'absent' ? 'danger' : 'warning')); ?>">
                                        <?php echo e(ucfirst($record->status)); ?>

                                    </span>
                                </td>
                                <td><?php echo e($record->time_in ? \Carbon\Carbon::parse($record->time_in)->format('H:i') : '-'); ?>

                                </td>
                                <td><?php echo e($record->time_out ? \Carbon\Carbon::parse($record->time_out)->format('H:i') : '-'); ?>

                                </td>
                                <td><?php echo e($record->remarks ?? '-'); ?></td>
                                <td>
                                    <button class="btn btn-sm btn-warning"
                                        onclick="editAttendance(<?php echo e($record->id); ?>)">Edit</button>
        ...
        <div class="mt-3">
            <form action="<?php echo e(route('super.attendance.delete-all')); ?>" method="POST"
