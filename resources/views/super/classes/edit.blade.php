...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-8">
                <form action="{{ route('super.classes.update', $class->id) }}" method="POST" id="classForm">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="year" id="year"
                                            ...
                                            <option value="1" {{ old('year', $class->year) == '1' ? 'selected' : '' }}>
                                                1st Year</option>
                                            <option value="2" {{ old('year', $class->year) == '2' ? 'selected' : '' }}>
                                                2nd Year</option>
                                            <option value="3" {{ old('year', $class->year) == '3' ? 'selected' : '' }}>
                                                3rd Year</option>
                                            <option value="4" {{ old('year', $class->year) == '4' ? 'selected' : '' }}>
                                                4th Year</option>
                                        </select>
                                        @error('year')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('section') is-invalid @enderror"
                                            ...
                                            value="{{ old('section', $class->section) }}" required>
                                        @error('section')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('capacity') is-invalid @enderror"
                                            ...
                                            value="{{ old('capacity', $class->capacity) }}" min="10" required>
                                        @error('capacity')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" id="status"
                                            ...
                                            <option value="Active"
                                                {{ old('status', $class->status) == 'Active' ? 'selected' : '' }}>Active
                                            </option>
