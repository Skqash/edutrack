...
<div class="searchable-dropdown-container" data-dropdown-id="{{ $id }}">
    <div class="searchable-dropdown-fixed {{ $class }}" 
         data-name="{{ $name }}" 
        ...
        <div class="dropdown-display-fixed" 
            ...
            <div class="dropdown-selected-fixed">
                <span class="selected-text-fixed placeholder">{{ $placeholder }}</span>
        ...
        <div class="dropdown-menu-fixed">
            ...
            <div class="dropdown-options-fixed">
                @if($createNew)
                    <div class="dropdown-option-fixed create-new-fixed" data-value="{{ $createNewValue }}">
                    ...
                    @foreach($options as $option)
                        @php
                            ...
                            $isSelected = $multiple ? 
                                ...
                                ($selected == $value);
                        @endphp
                        <div class="dropdown-option-fixed {{ $isSelected ? 'selected' : '' }}" 
                             data-value="{{ $value }}"
                            ...
                            @endif
                            <span>{{ $display }}</span>
                            @if(isset($option['description']) || (is_object($option) && isset($option->description)))
                                <small class="option-description-fixed">
                                    {{ is_array($option) ? $option['description'] : $option->description }}
                                </small>
                            @endif
                        </div>
                    @endforeach
