        ...
        <div class="col-lg-5">
            <div class="card password-card">
                <div class="card-body p-4">
                    <form
                        action="{{ route(auth()->user()->role === 'teacher' ? 'teacher.profile.change-password.update' : 'admin.profile.change-password.update') }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="action-buttons">
                            <a href="{{ auth()->user()->role === 'teacher' ? route('teacher.profile.show') : route('admin.profile.show') }}"
