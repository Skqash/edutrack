            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('admin.teachers.create') }}" class="btn btn-gradient-primary btn-sm">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="badge badge-gradient-warning rounded-circle" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                                                    {{ strtoupper(substr($teacher->name, 0, 1)) }}
                                                </div>
                                                <span class="ms-3">{{ $teacher->name }}</span>
                                            </div>
                                        </td>
                                        <td>{{ $teacher->email }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.teachers.edit', $teacher->id) }}" class="btn btn-sm btn-info" title="Edit">
