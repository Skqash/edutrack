            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <h6 class="fw-bold text-dark">{{ $subject->subject_code }}</h6>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <h5 class="fw-bold text-dark">{{ $subject->subject_name }}</h5>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <h6 class="fw-bold text-dark">
                                    <span class="badge bg-{{ $subject->type == 'Core' ? 'primary' : ($subject->type == 'Elective' ? 'warning' : 'info') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-dark">{{ $subject->description ?? 'No description available' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    @if($subject->course)
                        <div class="alert alert-success">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1 fw-bold">{{ $subject->course->program_name }}</h6>
                                    <p class="mb-0 text-muted">
                                        Program Code: {{ $subject->course->program_code }}<br>
                                        {{ $subject->course->college ?? 'No college specified' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fw-bold text-dark">{{ $subject->program ?? 'General Education' }}</h6>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @if($subject->instructor)
                        <div class="alert alert-info">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1 fw-bold">{{ $subject->instructor->name }}</h6>
                                    <p class="mb-0 text-muted">
                                        Role: {{ $subject->instructor->role }}<br>
