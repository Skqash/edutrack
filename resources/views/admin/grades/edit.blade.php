                        ...
                        <div class="form-row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('marks_obtained') is-invalid @enderror"
                                    id="marks_obtained" name="marks_obtained" value="{{ $grade->marks_obtained }}"
                                    step="0.01" required>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('total_marks') is-invalid @enderror"
                                    id="total_marks" name="total_marks" value="{{ $grade->total_marks }}" step="0.01"
                                    required>
                                @error('total_marks')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <select class="form-select @error('semester') is-invalid @enderror" id="semester"
                                    ...
                                    @for ($i = 1; $i <= 8; $i++)
                                        <option value="{{ $i }}"
                                            {{ $grade->semester == $i ? 'selected' : '' }}>Semester {{ $i }}
                                        </option>
                                    @endfor
                                </select>
                                @error('semester')
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('academic_year') is-invalid @enderror"
                                    id="academic_year" name="academic_year" value="{{ $grade->academic_year }}" required>
                                @error('academic_year')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
