...
<head>
    <meta charset="UTF-8">
    <title>Final Grades - {{ $student->user->name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="term-indicator">
            FINAL GRADES - {{ date('Y') }} Academic Year
        </div>
                    ...
                    @foreach ($grades as $grade)
                        <tr>
                            ...
                            <td style="text-align: center; font-weight: bold;">
                                @if ($grade->final_exam)
                                    @if ($grade->final_exam >= 75)
                                        <span style="color: #28a745;">{{ number_format($grade->final_exam, 2) }}</span>
                                    @else
                                        <span style="color: #dc3545;">{{ number_format($grade->final_exam, 2) }}</span>
                                    @endif
                                @else
