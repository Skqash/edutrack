...
<head>
    <meta charset="UTF-8">
    <title>Midterm Grades - {{ $student->user->name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="term-indicator">
            MIDTERM GRADES - {{ date('Y') }} Academic Year
        </div>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; font-weight: bold;">
                                @if ($grade->midterm_exam)
                                    @if ($grade->midterm_exam >= 75)
                                        <span style="color: #28a745;">{{ number_format($grade->midterm_exam, 2) }}</span>
                                    @else
                                        <span style="color: #dc3545;">{{ number_format($grade->midterm_exam, 2) }}</span>
                                    @endif
                                @else
        ...
        <div class="footer">
            ...
            <div class="footer-text">Generated on: {{ date('F j, Y g:i A') }}</div>
