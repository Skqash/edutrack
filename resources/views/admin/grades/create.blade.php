                    ...
                    <div class="form-row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('marks_obtained') is-invalid @enderror" id="marks_obtained" 
                                   name="marks_obtained" placeholder="e.g., 85" value="{{ old('marks_obtained') }}" step="0.01" required>
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('total_marks') is-invalid @enderror" id="total_marks" 
                                   name="total_marks" placeholder="e.g., 100" value="{{ old('total_marks') }}" step="0.01" required>
                            @error('total_marks')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('academic_year') is-invalid @enderror" id="academic_year" 
                                   name="academic_year" placeholder="e.g., 2023-24" value="{{ old('academic_year') }}" required>
                            @error('academic_year')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
