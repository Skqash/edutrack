...
@section('content')
    <div class="content-wrapper">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            id="total_students" name="total_students" placeholder="e.g., 60"
                                            value="{{ old('total_students') }}" min="1" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <x-searchable-dropdown
                                            ...
                                            :options="[
                                                ['id' => 'Active', 'name' => 'Active', 'description' => 'Class is currently active'],
                                                ['id' => 'Inactive', 'name' => 'Inactive', 'description' => 'Class is inactive']
                                            ]"
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fas fa-user-graduate"></i> Student Assignment
                </h5>
                <div class="form-check form-switch float-end">
                    <input class="form-check-input" type="checkbox" id="createAssignment" name="create_assignment"
                        value="1">
            ...
            <div class="card-body" id="assignmentSection" style="display: none;">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> Assign students to this class. You can select multiple students and they will be automatically enrolled in the class.
                </div>

                <!-- Remove Teacher and Subject Assignment section since teacher is already selected above -->
                <!-- Student Assignment Section directly -->
                
                <!-- Hidden fields to maintain compatibility with backend -->
                <input type="hidden" name="assignment_teachers[]" id="hidden_assignment_teachers" value="">
                <input type="hidden" name="assignment_subjects[]" id="hidden_assignment_subjects" value="">
                <input type="hidden" name="assignment_department" value="">
                <input type="hidden" name="assignment_notes" value="Auto-assigned from class creation">
                ...
                <div class="alert alert-warning mt-3">
                    ...
                    <strong>Note:</strong> When enabled, students can be selected and assigned to this class.
                    The class teacher selected above will be automatically assigned to manage this class.
                    Selected students will be enrolled in the class.
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new TomSelect('#teacher_id', {
                ...
                load: function(query, callback) {
                    if (!query.length) return callback();
                    fetch('/api/teachers/search?q=' + encodeURIComponent(query), {
                            headers: {
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')
                                    .getAttribute('content'),
                                'Accept': 'application/json'
            ...
            createAssignmentCheckbox.addEventListener('change', function() {
                ...
                if (this.checked) {
                    ...
                    // Auto-populate hidden teacher field with the selected class teacher
                    const classTeacherSelect = document.getElementById('teacher_id');
                    const hiddenTeacherInput = document.getElementById('hidden_assignment_teachers');
                    if (classTeacherSelect && classTeacherSelect.value && hiddenTeacherInput) {
                        hiddenTeacherInput.value = classTeacherSelect.value;
                        console.log('Auto-assigned teacher:', classTeacherSelect.value);
                    }
                    
                    // Auto-populate hidden subject field with the selected subject
                    const subjectSelect = document.getElementById('subject_id');
                    const hiddenSubjectInput = document.getElementById('hidden_assignment_subjects');
                    if (subjectSelect && subjectSelect.value && hiddenSubjectInput) {
                        hiddenSubjectInput.value = subjectSelect.value;
                        console.log('Auto-assigned subject:', subjectSelect.value);
                    }
