        ...
        <div class="page-header-modern">
            <div class="header-content">
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ route('admin.students.create') }}" class="btn btn-modern btn-modern-white">
                            ...
                            <table class="table table-modern">
                                ...
                                <tbody>
                                    @forelse ($students as $student)
                                        <tr>
                                            <td>
                                                <span class="badge badge-modern bg-info">{{ $student->student_id ?? 'N/A' }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="badge badge-modern bg-success">{{ $student->status ?? 'Active' }}</span>
                                            </td>
