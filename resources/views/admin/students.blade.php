                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span
                                                        class="ms-3 fw-500">{{ $student->user->name ?? $student->name }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <small
                                                    class="text-muted">{{ $student->user->email ?? $student->email }}</small>
                                            </td>
                                            <td>
                                                <small>{{ $student->created_at->format('d M Y') }}</small>
                                            </td>
                                            <td>
                                                <span
                                                    class="badge bg-gradient-success">{{ $student->status ?? 'Active' }}</span>
                                            </td>
