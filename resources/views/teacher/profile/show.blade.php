        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a href="{{ route('teacher.profile.edit') }}" class="btn btn-light me-2">
                        <i class="fas fa-edit me-2"></i> Edit Profile
                    </a>
                    <a href="{{ route('teacher.profile.change-password') }}" class="btn btn-outline-light">
        ...
        <div class="col-lg-4">
            ...
            <div class="card profile-card">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('teacher.grades') }}" class="list-group-item list-group-item-action">
