    ...
    <div class="page-header fade-in">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="{{ route('teacher.classes.create') }}" class="btn-modern btn-primary-modern">
            ...
            <div class="class-card fade-in" data-class-name="{{ $class->class_name ?? '' }}"
                ...
                <div class="class-header">
                    ...
                    <div class="class-meta">
                        ...
                        <span><i class="fas fa-school me-1"></i>S.Y. {{ $class->academic_year ?? 'N/A' }}</span>
                    </div>
                </div>
                ...
                <div class="class-footer">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ route('teacher.grades.results') }}?class_id={{ $class->id }}">
