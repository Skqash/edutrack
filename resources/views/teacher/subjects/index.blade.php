        ...
        <div class="page-header-modern">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="{{ route('teacher.dashboard') }}" class="btn btn-modern btn-modern-outline">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4">
                <div class="stat-card">
                    ...
                    <div class="stat-value" style="color: #667eea;">{{ count($courses) }}</div>
            ...
            <div class="col-md-4">
                <div class="stat-card">
                    ...
                    <div class="stat-value" style="color: #3b82f6;">{{ $totalClasses }}</div>
            ...
            <div class="col-md-4">
                <div class="stat-card">
                    ...
                    <div class="stat-value" style="color: #f59e0b;">{{ $totalStudents }}</div>
                        ...
                        <div class="subject-card">
                            <div class="subject-header">
                                <div>
                                    ...
                                    <div class="subject-code">{{ $course['code'] ?? 'No Code' }}</div>
