    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">
                ...
                {{ $class->class_name }} - {{ ucfirst($term) }} Term
            </h4>
            <small class="text-muted">{{ $class->course->program_name ?? 'N/A' }}</small>
        </div>
        ...
        <div class="card-body p-0">
            ...
            <div class="tab-content p-0">
                ...
                <div class="tab-pane fade show active" id="entry-pane" role="tabpanel">
                    @include('teacher.grades.advanced_grade_entry_embedded')
                </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="{{ route('teacher.grades.settings.index', $class->id) }}" class="btn btn-outline-primary">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="scheme-card">
                                ...
                                <a href="{{ route('teacher.grades.entry.old', $class->id) }}" class="btn btn-outline-secondary btn-sm">
                                    Use Classic Entry
                                </a>
                            </div>
                        </div>
...
@include('teacher.grades.components.component-manager-modal')
