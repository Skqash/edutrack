...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <a href="{{ route('teacher.students.add') }}" class="btn btn-success">
                                ...
                                @foreach($recentGrades as $grade)
                                    <tr>
                                        <td class="ps-3">
                                            ...
                                            <br>
                                            <small class="text-muted">{{ $grade->student->admission_number ?? 'N/A' }}</small>
                                        </td>
                                        <td class="d-none d-md-table-cell">
                                        ...
                                        <td class="text-center">
                                            <span class="grade-badge" style="padding: 6px 12px; border-radius: 5px; font-weight: bold;
                                                ...
                                                @endif
                                            ">
                                                {{ $grade->final_grade }} ({{ \App\Models\Grade::getLetterGrade($grade->final_grade) }})
                                            </span>
                                        </td>
                                        <td class="d-none d-md-table-cell">
