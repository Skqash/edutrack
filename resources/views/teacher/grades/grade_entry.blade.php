                                ...
                                @foreach ($students as $student)
                                    ...
                                    <tr data-student-id="{{ $student->id }}">
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="100"
                                                class="form-control form-control-sm text-center grade-input exam-pr" name="grades[{{ $student->id }}][exam_pr]"
                                                value="{{ intval($entry->exam_pr ?? 0) }}"></td>
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="100"
                                                class="form-control form-control-sm text-center grade-input exam-md" name="grades[{{ $student->id }}][exam_md]"
                                        ...
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="25"
                                                class="form-control form-control-sm text-center grade-input quiz-1" name="grades[{{ $student->id }}][quiz_1]"
                                                value="{{ intval($entry->quiz_1 ?? 0) }}"></td>
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="25"
                                                class="form-control form-control-sm text-center grade-input quiz-2" name="grades[{{ $student->id }}][quiz_2]"
                                                value="{{ intval($entry->quiz_2 ?? 0) }}"></td>
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="25"
                                                class="form-control form-control-sm text-center grade-input quiz-3" name="grades[{{ $student->id }}][quiz_3]"
                                                value="{{ intval($entry->quiz_3 ?? 0) }}"></td>
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="25"
                                                class="form-control form-control-sm text-center grade-input quiz-4" name="grades[{{ $student->id }}][quiz_4]"
                                                value="{{ intval($entry->quiz_4 ?? 0) }}"></td>
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="25"
                                                class="form-control form-control-sm text-center grade-input quiz-5" name="grades[{{ $student->id }}][quiz_5]"
                                                value="{{ intval($entry->quiz_5 ?? 0) }}"></td>
                                        <td class="computed-cell quiz-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->quiz_average !== null ? number_format($entry->quiz_average, 2) : '-' }}
                                        </td>
                                        ...
                                        <!-- OUTPUT -->
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="100"
                                                class="form-control form-control-sm text-center grade-input output-1" name="grades[{{ $student->id }}][output_1]"
                                                value="{{ intval($entry->output_1 ?? 0) }}"></td>
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="100"
                                                class="form-control form-control-sm text-center grade-input output-2" name="grades[{{ $student->id }}][output_2]"
                                                value="{{ intval($entry->output_2 ?? 0) }}"></td>
                                        <td><input type="text" inputmode="numeric" pattern="[0-9]*" data-min="0" data-max="100"
                                                class="form-control form-control-sm text-center grade-input output-3" name="grades[{{ $student->id }}][output_3]"
                                                value="{{ intval($entry->output_3 ?? 0) }}"></td>
                                        <td class="computed-cell output-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->output_average !== null ? number_format($entry->output_average, 2) : '-' }}
                                        </td>
                                        ...
                                        <td class="computed-cell classpart-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->classpart_average !== null ? number_format($entry->classpart_average, 2) : '-' }}
                                        </td>
                                        ...
                                        <td class="computed-cell activity-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->activity_average !== null ? number_format($entry->activity_average, 2) : '-' }}
                                        </td>
                                        ...
                                        <td class="computed-cell assignment-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->assignment_average !== null ? number_format($entry->assignment_average, 2) : '-' }}
                                        </td>

                                        <!-- SKILLS AVE -->
                                        <td class="computed-cell skills-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->skills_average !== null ? number_format($entry->skills_average, 2) : '-' }}
                                        </td>
                                        ...
                                        <td class="computed-cell behavior-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->behavior_average !== null ? number_format($entry->behavior_average, 2) : '-' }}
                                        </td>
                                        ...
                                        <td class="computed-cell awareness-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->awareness_average !== null ? number_format($entry->awareness_average, 2) : '-' }}
                                        </td>

                                        <!-- ATTITUDE AVE -->
                                        <td class="computed-cell attitude-ave table-secondary fw-semibold">
                                            {{ $entry && $entry->attitude_average !== null ? number_format($entry->attitude_average, 2) : '-' }}
                                        </td>
                                        ...
                                        <td class="computed-cell final-grade table-secondary fw-semibold">
                                            {{ $entry && $entry->term_grade !== null ? number_format($entry->term_grade, 2) : '-' }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="card border-success shadow-lg">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0 mt-2">
                                <li>Transfer all saved {{ ucfirst($term) }} grades to the permanent <strong>grades</strong>
                                    table</li>
