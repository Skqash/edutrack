                ...
                <div class="card shadow-sm w-100" style="max-width: 100%; margin: 0;">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('teacher.classes') }}" class="btn btn-sm btn-outline-secondary">← Back</a>
                        </div>
                    </div>
                                        ...
                                        @foreach ($students as $student)
                                            ...
                                            <tr data-student-id="{{ $student->id }}">
                                                ...
                                                <td class="text-start bg-white fw-semibold" style="color: #2c3e50;">
                                                    {{ $student->user->name ?? $student->name }}</td>

                                                <!-- EXAM -->
                                                @if ($term == 'midterm')
                                                    <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                            data-min="0"
                                                            data-max="{{ $range->midterm_exam_max ?? 100 }}"
                                                ...
                                                <!-- QUIZZES -->
                                                <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                        data-min="0" data-max="{{ $range->quiz_1_max ?? 25 }}"
                                                ...
                                                <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                        data-min="0" data-max="{{ $range->quiz_2_max ?? 25 }}"
                                                ...
                                                <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                        data-min="0" data-max="{{ $range->quiz_3_max ?? 25 }}"
                                                ...
                                                <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                        data-min="0" data-max="{{ $range->quiz_4_max ?? 25 }}"
                                                ...
                                                <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                        data-min="0" data-max="{{ $range->quiz_5_max ?? 25 }}"
                                                ...
                                                <td><input type="text" inputmode="numeric" pattern="[0-9]*"
                                                        data-min="0" data-max="{{ $range->attendance_max ?? 100 }}"
                ...
                <div class="modal-content">
                    <div class="card border-success shadow-lg">
                        ...
                        <div class="modal-footer">
                            ...
                            <form method="POST"
                                action="{{ route('teacher.grades.upload', ['classId' => $class->id]) }}"
