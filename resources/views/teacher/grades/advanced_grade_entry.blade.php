            ...
            <div class="alert alert-info border-0 shadow-sm mb-4">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="{{ route('teacher.grades.content', $class->id) }}" class="btn btn-outline-primary btn-sm">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th colspan="2" class="knowledge-header">
                                <i class="fas fa-brain me-1"></i>Knowledge ({{ ($ksaSettings->knowledge_weight ?? 0.4) * 100 }}%)
                            </th>
                            
                            <!-- Skills Headers -->
                            <th colspan="2" class="skills-header">
                                <i class="fas fa-tools me-1"></i>Skills ({{ ($ksaSettings->skills_weight ?? 0.5) * 100 }}%)
                            </th>
                            
                            <!-- Attitude Headers -->
                            <th colspan="2" class="attitude-header">
                                <i class="fas fa-heart me-1"></i>Attitude ({{ ($ksaSettings->attitude_weight ?? 0.1) * 100 }}%)
                            </th>
                        ...
                        <tr>
                            ...
                            @if(isset($ksaSettings->components->knowledge))
                                @foreach($ksaSettings->components->knowledge as $index => $component)
                                    <th class="knowledge-header">{{ $component->name }} ({{ $component->weight }}%)</th>
                                @endforeach
                            @else
                            ...
                            @if(isset($ksaSettings->components->attitude))
                                @foreach($ksaSettings->components->attitude as $index => $component)
                                    <th class="attitude-header">{{ $component->name }} ({{ $component->weight }}%)</th>
                                @endforeach
                            @else
