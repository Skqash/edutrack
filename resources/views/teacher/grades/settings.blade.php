...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span id="settingsModeIndicator" class="badge fs-5 px-3 py-2 {{ 
                            ($gradingScaleSettings->component_weight_mode ?? 'semi-auto') === 'manual' ? 'bg-primary' : 
                            (($gradingScaleSettings->component_weight_mode ?? 'semi-auto') === 'auto' ? 'bg-warning text-dark' : 'bg-success') 
                        }}">
                            {{ 
                                ($gradingScaleSettings->component_weight_mode ?? 'semi-auto') === 'manual' ? '🎯 Manual Mode' : 
                                (($gradingScaleSettings->component_weight_mode ?? 'semi-auto') === 'auto' ? '🤖 Auto Mode' : '🔄 Semi-Auto Mode') 
                            }}
                        </span>
                    </div>
                </div>
                <a href="{{ route('teacher.classes') }}" class="btn btn-sm btn-outline-secondary mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('teacher.grades.settings.update-ksa', $class->id) }}">
                    @csrf
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input type="range" name="knowledge_weight" class="form-range" min="0"
                                    max="100" value="{{ $ksaSettings->knowledge_weight ?? 40 }}">
                                <span class="badge bg-primary"
                                    id="k-display">{{ $ksaSettings->knowledge_weight ?? 40 }}%</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input type="range" name="skills_weight" class="form-range" min="0" max="100"
                                    value="{{ $ksaSettings->skills_weight ?? 50 }}">
                                <span class="badge bg-success"
                                    id="s-display">{{ $ksaSettings->skills_weight ?? 50 }}%</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input type="range" name="attitude_weight" class="form-range" min="0"
                                    max="100" value="{{ $ksaSettings->attitude_weight ?? 10 }}">
                                <span class="badge bg-danger"
                                    id="a-display">{{ $ksaSettings->attitude_weight ?? 10 }}%</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('teacher.grades.settings.update-attendance', $class->id) }}">
                    @csrf
                    <input type="hidden" name="term" value="{{ $term }}">
