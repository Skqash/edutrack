                            ...
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-center">
                                        <small><strong>Knowledge</strong><br><span class="text-muted">(0-100)</span></small>
                                    </th>
                                    <th class="text-center">
                                        <small><strong>Skills</strong><br><span class="text-muted">(0-100)</span></small>
                                    </th>
                                    <th class="text-center">
                                        <small><strong>Attitude</strong><br><span class="text-muted">(0-100)</span></small>
                                    </th>
                                    <th class="text-center">
                            ...
                            <tbody>
                                @forelse($class->students as $index => $student)
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3">
                                            <input type="number" 
                                                name="grades[{{ $index }}][knowledge_score]" 
                                                class="form-control form-control-sm knowledge-input"
                                                min="0" max="100" step="0.5"
                                                value="{{ $grade ? $grade->knowledge_score : '' }}"
                                                placeholder="0-100"
                                                required>
                                        ...
                                        <td class="py-3">
                                            <input type="number" 
                                                name="grades[{{ $index }}][skills_score]" 
                                                class="form-control form-control-sm skills-input"
                                                min="0" max="100" step="0.5"
                                                value="{{ $grade ? $grade->skills_score : '' }}"
                                                placeholder="0-100"
                                                required>
                                        ...
                                        <td class="py-3">
                                            <input type="number" 
                                                name="grades[{{ $index }}][attitude_score]" 
                                                class="form-control form-control-sm attitude-input"
                                                min="0" max="100" step="0.5"
                                                value="{{ $grade ? $grade->attitude_score : '' }}"
                                                placeholder="0-100"
                                                required>
                                        ...
                                        <td class="py-3">
                                            <input type="text" 
                                                ...
                                                value="{{ $grade ? $grade->final_grade . ' (' . \App\Models\Grade::getLetterGrade($grade->final_grade) . ')' : '' }}"
                                                readonly
