    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="excelImportForm" method="POST" action="{{ route('teacher.students.import') }}" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label for="class_id_excel" class="form-label">Class<span class="text-danger">*</span></label>
                            <select class="form-select @error('class_id') is-invalid @enderror" id="class_id_excel" name="class_id" required>
                                <option value="">-- Select Class --</option>
                                @foreach($myClasses as $class)
                        ...
                        <a href="{{ asset('templates/students_import_template.xlsx') }}" class="btn btn-sm btn-secondary mb-3 w-100">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-outline-danger" title="Remove" onclick="confirmRemove({{ $student->id }})">
